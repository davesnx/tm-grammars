...
let json = {json|{
  ...
  "patterns": [
    {
      "match": "\\b(?:void\\b|half\\b|bfloat\\b|float\\b|double\\b|x86_fp80\\b|fp128\\b|ppc_fp128\\b|label\\b|metadata\\b|x86_mmx\\b|x86_amx\\b|type\\b|label\\b|opaque\\b|token\\b|i\\d+\\**)",
    ...
    {
      "match": "(?:(?<=\\s|^)#dbg_(assign|declare|label|value)|\\badd|\\baddrspacecast|\\balloca|\\band|\\barcp|\\bashr|\\batomicrmw|\\bbitcast|\\bbr|\\bcatchpad|\\bcatchswitch|\\bcatchret|\\bcall|\\bcallbr|\\bcleanuppad|\\bcleanupret|\\bcmpxchg|\\beq|\\bexact|\\bextractelement|\\bextractvalue|\\bfadd|\\bfast|\\bfcmp|\\bfdiv|\\bfence|\\bfmul|\\bfpext|\\bfptosi|\\bfptoui|\\bfptrunc|\\bfree|\\bfrem|\\bfreeze|\\bfsub|\\bfneg|\\bgetelementptr|\\bicmp|\\binbounds|\\bindirectbr|\\binsertelement|\\binsertvalue|\\binttoptr|\\binvoke|\\blandingpad|\\bload|\\blshr|\\bmalloc|\\bmax|\\bmin|\\bmul|\\bnand|\\bne|\\bninf|\\bnnan|\\bnsw|\\bnsz|\\bnuw|\\boeq|\\boge|\\bogt|\\bole|\\bolt|\\bone|\\bord??|\\bphi|\\bptrtoint|\\bresume|\\bret|\\bsdiv|\\bselect|\\bsext|\\bsge|\\bsgt|\\bshl|\\bshufflevector|\\bsitofp|\\bsle|\\bslt|\\bsrem|\\bstore|\\bsub|\\bswitch|\\btrunc|\\budiv|\\bueq|\\buge|\\bugt|\\buitofp|\\bule|\\bult|\\bumax|\\bumin|\\bune|\\buno|\\bunreachable|\\bunwind|\\burem|\\bva_arg|\\bxchg|\\bxor|\\bzext)\\b",
    ...
    {
      "match": "\\b(?:true|false|null|zeroinitializer|undef|poison|null|none)\\b",
      "name": "constant.language"
    },
    {
      "match": "\\bD(?:W_TAG_[_a-z]+|W_ATE_[A-Z_a-z]+|W_OP_[0-9A-Z_a-z]+|W_LANG_[0-9A-Z_a-z]+|W_VIRTUALITY_[_a-z]+|IFlag[A-Za-z]+)\\b",
      "name": "constant.other"
    },
    {
      "match": ";\\s*PR\\d*\\s*$",
