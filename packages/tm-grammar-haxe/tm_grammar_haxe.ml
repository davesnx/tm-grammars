...
let json = {json|{
  ...
  "repository": {
    ...
    "constants": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b0[Xx]\\h[_\\h]*([iu][0-9][0-9_]*)?\\b"
        },
        {
          "captures": {
            "0": {
          ...
          "match": "\\b0[Bb][01][01_]*([iu][0-9][0-9_]*)?\\b"
        },
        {
          "captures": {
            "0": {
      ...
      "patterns": [
        {
          ...
          "match": "(@(?:param|exception|throws|event))\\s+([A-Z_a-z]\\w*)\\s+"
        },
        {
          "captures": {
            "1": {
        ...
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "\\b(var|final)\\b\\s*([A-Z_a-z]\\w*)\\b"
            },
            {
              "include": "#array"
            },
    ...
    "method-name": {
      "begin": "\\b(function)\\b\\s*\\b(?:(new)|([A-Z_a-z]\\w*))?\\b",
      "beginCaptures": {
        "1": {
