...
let json =
  ...
  "patterns": [
    ...
    },
    {
      ...
      "match": "^\\s*(sca(l(?:ar?|))?(\\s+de(f(?:ine?|i?))?)?)\\s+(?!(drop|dir?|l(i(?:st?|))?)\\s+)"
    },
    {
      "begin": "\\b(mer(ge?)?)\\s+([1mn])(:)([1mn])",
      "beginCaptures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(foreach)\\s+((?!in|of).+)\\s+(in|of var(l(?:ist?|i?))?|of new(l(?:ist?|i?))?|of num(l(?:ist?|i?))?)\\b"
    },
    {
      "begin": "\\b(foreach)\\s+((?!in|of).+)\\s+(of (?:loc(al?)?|glo(b(?:al?|))?))\\b\\s*",
      "beginCaptures": {
        "1": {
          "name": "keyword.control.flow.stata"
        },
    ...
    },
    {
      ...
      "match": "\\b(as(?:|se??|sert??))\\b"
    },
    {
      "match": "\\b(by(s(?:ort?|o?))?|statsby|rolling|bootstrap|jackknife|permute|simulate|svy|mi est(i(?:mate?|ma?|))?|nestreg|stepwise|xi|fp|mfp|vers(i(?:on?|))?)\\b",
      "name": "storage.type.function.stata"
    },
    {
      "match": "\\b(qui(e(?:tly?|t?))?|n(o(?:isily?|isi?|i?))?|cap(t(?:ure?|u?))?)\\b:?",
      "name": "keyword.control.flow.stata"
    },
    {
      "captures": {
      ...
      "match": "\\s*(pr(o(?:gram?|gr?|))?)\\s+((di(r)?|drop|l(i(?:st?|))?)\\s+)([\\w&&[^0-9]]\\w{0,31})"
    },
    {
      "begin": "^\\s*(pr(o(?:gram?|gr?|))?)\\s+(de(f(?:ine?|i?))?\\s+)?",
      "beginCaptures": {
        "1": {
          "name": "storage.type.function.stata"
        },
    ...
    },
    {
      ...
      "match": "\\b(form(at?)?)\\s*([\\w&&[^0-9]]\\w{0,31})*\\s*(%)(-)?(0)?([0-9]+)(.)([0-9]+)([efg])(c)?"
    },
    {
              ...
              "patterns": [
                {
                  ...
                  "match": "\\b(integer?|integ?|int|real|string?|stri?)\\b"
                },
                {
                  "include": "#constants"
                },
    ...
    },
    {
      ...
      "match": "\\b(sa(ve??)|saveold|destring|tostring|u(se?)?|note(s)?|form(at?)?)\\b"
    },
    {
      "match": "\\b(e(?:xit|nd))\\b",
      "name": "keyword.functions.data.stata"
    ...
    },
    {
      ...
      "match": "\\b(g(e(?:nerate?|nera?|ne?|))?|egen)\\s+((byte|int|long|float|double|str[1-9]?[0-9]?[0-9]?[0-9]?|strL)\\s+)?([^=\\s]+)\\s*((==)|(=))"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(set ty(pe?)?)\\s+((byte|int|long|float|double|str[1-9]?[0-9]?[0-9]?[0-9]?|strL)?\\s+)\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(la(b(?:el?|))?)\\s+(var(i(?:able?|ab?|))?)\\s+([\\w&&[^0-9]]\\w{0,31})\\s+(`\")(.+)(\"')"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(la(b(?:el?|))?)\\s+(da(ta?)?|var(i(?:able?|ab?|))?|de(f(?:|in??|ine))?|val(u(?:es?|))?|di(r)?|l(i(?:st?|))?|copy|drop|save|lang(u(?:age?|a?))?)\\b"
    },
    {
      "begin": "\\b(drop|keep)\\b(?!\\s+(i[fn])\\b)",
      "beginCaptures": {
        "1": {
          "name": "keyword.functions.data.stata"
        }
  ...
  "repository": {
    ...
    "builtin_variables": {
      "patterns": [
        {
          "match": "\\b(_(?:b|coef|cons|[Nn]|rc|se))\\b",
    ...
    "constants": {
      "patterns": [
        ...
        {
          "match": "\\b(?i:(\\d+\\.\\d*(e[-+]?\\d+)?))(?=[^A-Z_a-z])",
          "name": "constant.numeric.float.stata"
        },
        {
          "match": "(?<=[^0-9A-Z_a-z])(?i:(\\.\\d+(e[-+]?\\d+)?))",
          "name": "constant.numeric.float.stata"
        },
        {
          "match": "\\b(?i:(\\d+e[-+]?\\d+))",
    ...
    "macro-commands": {
      "patterns": [
        ...
        {
          "begin": "\\b(temp(?:var|name|file))\\s*(?=\\s)",
          "beginCaptures": {
            "1": {
              "name": "keyword.macro.stata"
            }
        ...
        {
          "begin": "\\b(ma(c(?:ro?|))?)\\s+(drop|l(i(?:st?|))?)\\s*(?=\\s)",
          "beginCaptures": {
            "0": {
              "name": "keyword.macro.stata"
            }
    ...
    "macro-extended-functions": {
      "patterns": [
        ...
        {
          "match": "\\b(t(y(?:pe?|))?|f(o(?:rmat?|rm?|))?|val(ue?)?\\s+l(a(?:ble?|b?))?|var(i(?:able?|ab?|))?\\s+l(a(?:bel?|b?))?|data\\s+l(a(?:ble?|b?))?|sort(e(?:dby?|d?))?|lab(el?)?|maxlength|constraint|char)\\b",
          "name": "keyword.macro.extendedfcn.stata"
        },
        {
          "match": "\\b(permname)\\b",
        ...
        {
          "match": "\\b(env(i(?:ronment?|ronme?|ron?|r?))?)\\b",
          "name": "keyword.macro.extendedfcn.stata"
        },
        {
        ...
        },
        {
          ...
          "match": "\\b(list)\\s+(uniq|dups|sort|clean|retok(e(?:nize?|ni?|))?|sizeof)\\s+(\\w{1,32})"
        },
        {
          "captures": {
            "1": {
        ...
        {
          "match": "\\b(rown(a(?:mes?|m?))?|coln(a(?:mes?|m?))?|rowf(u(?:llnames?|llnam?|lln?|l?))?|colf(u(?:llnames?|llnam?|lln?|l?))?|roweq?|coleq?|rownumb|colnumb|roweqnumb|coleqnumb|rownfreeparms|colnfreeparms|rownlfs|colnlfs|rowsof|colsof|rowvarlist|colvarlist|rowlfnames|collfnames)\\b",
          "name": "keyword.macro.extendedfcn.stata"
        },
        {
          "match": "\\b(tsnorm)\\b",
        ...
        },
        {
          ...
          "match": "\\b((copy|(ud?)?strlen)\\s+(loc(al?)?|gl(o(?:bal?|b?))?))\\s+([^']+)"
        },
        {
          "captures": {
            "1": {
        ...
        {
          "begin": "\\b(subinstr\\s+(loc(al?)?|gl(o(?:bal?|b?))?))\\s+(\\w{1,32})",
          "beginCaptures": {
            "1": {
              "name": "keyword.macro.extendedfcn.stata"
            },
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(c(?:ount?|ou?|))(\\()(local?|loc|global?|glob?|gl)\\s+(\\w{1,32})(\\))"
            }
          ]
        },
        {
    ...
    "reserved-names": {
      "patterns": [
        {
          "match": "\\b(_all|_b|byte|_coef|_cons|double|float|if|int??|long|_n|_N|_pi|_pred|_rc|_skip|str[0-9]+|strL|using|with)\\b",
          "name": "invalid.illegal.name.stata"
        },
        {
          "match": "[^$'()`\\w\\s]",
    ...
    "unicode-regex-internals": {
      "patterns": [
        ...
        {
          "begin": "(\\()(\\?\\(([1-9][0-9]?|[A-Z_a-z][0-9A-Z_a-z]*)\\))",
          "beginCaptures": {
            "1": {
