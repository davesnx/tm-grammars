  ...
  "repository": {
    ...
    "constants": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b0[hx]\\h[_\\h]*\\.(?:(?:\\h[_\\h]*)?(?:p[-+]?[0-9][0-9_]*)?\\b)?",
          "name": "constant.numeric.hex.floating-point.asm.x86_64"
        },
        {
          "match": "(?i)\\b0[hx]\\h[_\\h]*p[-+]?[0-9][0-9_]*\\b",
          "name": "constant.numeric.hex.floating-point.asm.x86_64"
        },
        {
          "match": "(?i)\\$[0-9]_?(?:\\h[_\\h]*)?\\.(?:(?:\\h[_\\h]*)?(?:p[-+]?[0-9][0-9_]*)?\\b)?",
          "name": "constant.numeric.hex.floating-point.asm.x86_64"
        },
        {
          "match": "(?i)\\$[0-9]_?\\h[_\\h]*p[-+]?[0-9][0-9_]*\\b",
          "name": "constant.numeric.hex.floating-point.asm.x86_64"
        },
        {
        ...
        {
          "match": "(?i)\\$[0-9]_?(?:\\h[_\\h]*)?\\b",
          "name": "constant.numeric.hex.asm.x86_64"
        },
        {
          "match": "(?i)\\b(?:0[hx]\\h[_\\h]*|\\h[_\\h]*[HXhx])\\b",
          "name": "constant.numeric.hex.asm.x86_64"
        }
      ]
    },
    ...
    "mnemonics-avx2": {
      "patterns": [
        {
          "match": "(?i)\\b(v((broadcast|extract|insert|perm2)i128|pmaskmov[dq]|perm([dqs]|p[ds])))\\b",
    ...
    "mnemonics-avx512fp16": {
      "patterns": [
        ...
        {
          "match": "(?i)\\bvcvt(s[dis]|usi)2sh\\b",
          "name": "keyword.operator.word.mnemonic.avx512.fp16.cvtx2sh"
        },
        {
          "match": "(?i)\\bvcvtsh2(s[dis]|usi)\\b",
    ...
    "mnemonics-fpu": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b(fld([1z]|pi|l2[et]|l[gn]2))\\b",
    ...
    "mnemonics-general-purpose": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b(s[ah][lr]|sh[lr]d|r[co][lr])\\b",
    ...
    "mnemonics-mmx": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b(p(((add|sub)(d|(u?s)?[bw]))|maddwd|mul[hl]w))\\b",
        ...
        {
          "match": "(?i)\\b(ps([lr]l[dqw]|raw|rad))\\b",
    ...
    "mnemonics-sse": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b(prefetch(nta|t[012]|w(t1)?))\\b",
    ...
    "mnemonics-sse3": {
      "patterns": [
        {
          "match": "(?i)\\b(fisttp|lddqu|(addsub|h(add|sub))p[ds]|mov(sh|sl|d)dup|monitor|mwait)\\b",
    ...
    "mnemonics-system": {
      "patterns": [
        {
          "match": "(?i)\\b((cl|st)ac|[ls]([gil]dt|tr|msw)|clts|arpl|lar|lsl|ver[rw]|inv(d|lpg|pcid)|wbinvd)\\b",
    ...
    "mnemonics-undocumented": {
      "patterns": [
        {
          "match": "(?i)\\b(ret[fn]|icebp|int1|int03|smi|ud1)\\b",
    ...
    "registers": {
      "patterns": [
        {
          "match": "(?i)\\b(?:[a-d][hl]|[er]?[a-d]x|[er]?(?:di|si|bp|sp)|dil|sil|bpl|spl|r(?:[89]|1[0-5])[bdlw]?)\\b",
    ...
    "support": {
      "patterns": [
        ...
        {
          "match": "\\b__\\?(?:utf(?:16|32)(?:[bl]e)?|float(?:8|16|32|64|80[em]|128[hl])|bfloat16|Infinity|[QS]?NaN)\\?__\\b",
          "name": "support.function.asm.x86_64"
        },
        {
          "match": "\\b__(?:utf(?:16|32)(?:[bl]e)?|float(?:8|16|32|64|80[em]|128[hl])|bfloat16|Infinity|[QS]?NaN)__\\b",
        ...
        {
          "match": "\\bfloat(?:8|16|32|64|80[em]|128[hl])\\b",
          "name": "support.function.fp.asm.x86_64"
        },
        {
          "match": "(?i)\\bilog2(?:[cefw]|[cf]w)?\\b",
