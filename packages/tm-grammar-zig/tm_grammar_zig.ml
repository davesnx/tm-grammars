  ...
  "repository": {
    ...
    "keywords": {
      "patterns": [
        ...
        {
          "match": "\\b(c_(?:char|short|ushort|int|uint|long|ulong|longlong|ulonglong|longdouble))\\b",
    ...
    "numbers": {
      "patterns": [
        {
          "match": "\\b0x\\h[_\\h]*(\\.\\h[_\\h]*)?([Pp][-+]?[_\\h]+)?\\b",
        ...
        {
          "match": "\\b[0-9](([EPep][-+])|[0-9A-Z_a-z])*(\\.(([EPep][-+])|[0-9A-Z_a-z])*)?([EPep][-+])?[0-9A-Z_a-z]*\\b",
      ...
      "patterns": [
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "\\b(fn)\\s+([A-Z_a-z][0-9A-Z_a-z]*)\\b"
            },
            {
              "begin": "\\b(fn)\\s+@\"",
              "beginCaptures": {
