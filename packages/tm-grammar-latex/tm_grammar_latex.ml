...
let json =
  ...
  "repository": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "patterns": [
            ...
            {
              "begin": "\\G(\\{)(?:__|[a-z\\s]*)(?i:t(?:s|ypescript))",
              "beginCaptures": {
                "1": {
                  "name": "punctuation.definition.arguments.begin.latex"
                }
            ...
            {
              "begin": "\\G(\\{)(?:__|[a-z\\s]*)(?i:tikz(?:|picture))",
              "beginCaptures": {
                "1": {
                  "name": "punctuation.definition.arguments.begin.latex"
                }
    ...
    "hyperref-macro": {
      "patterns": [
        {
          "begin": "\\s*((\\\\)h(?:ref|yperref|yperimage))(?=[\\[{])",
          "beginCaptures": {
            "1": {
    ...
    "inline-code-macro": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "((\\\\)mint(?:|inline))((?:\\[[^\\[]*?])?)(\\{)[A-Za-z]*(})(?:([^A-Za-{])(.*?)(\\6)|(\\{)(.*?)(}))",
        ...
        },
        {
          ...
          "match": "((\\\\)(?:(?:py|pycon|pylab|pylabcon|sympy|sympycon)[cv]?|pyq|pycq|pyif))((?:\\[[^\\[]*?])?)(?:([^](),;A-\\[a-{}\\s])(.*?)(\\4)|(\\{)(.*?)(}))",
          "name": "meta.function.verb.latex"
        },
        {
          "captures": {
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:asy(?:|mptote))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:h(?:s|askell))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:j(?:l|ulia))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:j(?:s|avascript))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:t(?:s|ypescript))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
        ...
        {
          "begin": "((\\\\)cacheMeCode)(?=\\[(?i:tikz(?:|picture))\\b|\\{)",
          "beginCaptures": {
            "1": {
              "name": "support.function.verb.latex"
            },
    ...
    "macro-with-args-tokenizer": {
      ...
      "match": "\\s*((\\\\)\\p{Alphabetic}+)(\\{)(\\\\?\\p{Alphabetic}+\\*?)(})(?:(\\[)([^]]*)(])){0,2}(?:(\\{)([^{}]*)(}))?"
    },
    ...
    "references-macro": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "((\\\\)\\w*[Rr]efrange\\*?)(?:\\[[^]]*])?(\\{)([!*,-/:^_\\p{Alphabetic}\\p{N}]+)(})(\\{)([!*,-/:^_\\p{Alphabetic}\\p{N}]+)(})"
        },
        {
          "begin": "((\\\\)bibentry)(\\{)",
          "captures": {
    ...
    "verb-macro": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "((\\\\)(?:[Vv]|spv)erb\\*?)\\s*((?<=\\s)\\S|[^A-Za-z])(.*?)(\\3|$)",
          "name": "meta.function.verb.latex"
        }
      ]
    },
    "verbatim-env": {
      "patterns": [
        {
          "begin": "(\\s*\\\\begin\\{((?:fboxv|boxedv|[Vv]|spv)erbatim\\*?)})",
          "captures": {
            "1": {
              "patterns": [
                {
