let all = [
  ...
  (Tm_grammar_dune_project.lang_id, Tm_grammar_dune_project.json);
  (Tm_grammar_dune_workspace.lang_id, Tm_grammar_dune_workspace.json);
  ...
  (Tm_grammar_ocaml_interface.lang_id, Tm_grammar_ocaml_interface.json);
