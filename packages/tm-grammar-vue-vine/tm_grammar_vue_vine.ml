...
let json = {json|{
  ...
  "repository": {
    "access-modifier": {
      ...
      "name": "storage.modifier.vue-vine"
    },
    "after-operator-block-as-object-literal": {
      ...
      "beginCaptures": {
        "1": {
          "name": "punctuation.definition.block.vue-vine"
        }
      },
      "end": "}",
      "endCaptures": {
      ...
      "name": "meta.objectliteral.vue-vine",
      "patterns": [
        {
    ...
    "array-binding-pattern": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.operator.rest.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.binding-pattern.array.vue-vine"
        }
      },
      "end": "]",
      "endCaptures": {
    ...
    "array-literal": {
      ...
      "beginCaptures": {
        "1": {
          "name": "meta.brace.square.vue-vine"
        }
      },
      "end": "]",
      "endCaptures": {
      ...
      "name": "meta.array.literal.vue-vine",
      "patterns": [
        {
          "include": "#expression"
        },
      ...
      "patterns": [
        {
          "captures": {
            "1": {
              "name": "storage.modifier.async.vue-vine"
            },
            "2": {
              "name": "variable.parameter.vue-vine"
            }
          },
          "match": "(?:(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))\\b(async)\\s+)?([$_[:alpha:]][$_[:alnum:]]*)\\s*(?==>)",
          "name": "meta.arrow.vue-vine"
        },
        {
        ...
        },
        {
          ...
          "beginCaptures": {
            "0": {
              "name": "storage.type.function.arrow.vue-vine"
            }
          },
          "end": "((?<=[}\\S])(?<!=>)|((?!\\{)(?=\\S)))(?!/[*/])",
          "name": "meta.arrow.vue-vine",
    ...
    "arrow-return-type": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.operator.type.annotation.vue-vine"
        }
      },
      "end": "(?==>|\\{|^(\\s*(export|function|class|interface|let|var|const|import|enum|namespace|module|type|abstract|declare)\\s+))",
      "name": "meta.return.type.arrow.vue-vine",
      "patterns": [
        {
      ...
      "patterns": [
        {
          ...
          "name": "constant.language.boolean.true.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))false(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "constant.language.boolean.false.vue-vine"
        }
      ]
    },
    "brackets": {
      ...
      "patterns": [
        {
          "captures": {
            "1": {
              "name": "meta.brace.angle.vue-vine"
            },
            "2": {
              "name": "storage.modifier.vue-vine"
            },
    ...
    "class-declaration": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.control.export.vue-vine"
        },
        "2": {
          "name": "storage.modifier.vue-vine"
        },
        ...
        "4": {
          "name": "storage.type.class.vue-vine"
        }
      },
      "end": "(?<=})",
      "name": "meta.class.vue-vine",
      "patterns": [
        {
    ...
    "class-declaration-or-expression-patterns": {
      "patterns": [
        ...
        },
        {
          "captures": {
            "0": {
              "name": "entity.name.type.class.vue-vine"
            }
          },
    ...
    "class-or-interface-heritage": {
      ...
      "patterns": [
        ...
        },
        {
          "captures": {
            "1": {
              "name": "entity.name.type.module.vue-vine"
            },
            "2": {
              "name": "punctuation.accessor.vue-vine"
            },
            "3": {
              "name": "punctuation.accessor.optional.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            "1": {
              "name": "entity.other.inherited-class.vue-vine"
            }
          },
          "match": "([$_[:alpha:]][$_[:alnum:]]*)"
        },
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "0": {
              "name": "punctuation.definition.comment.vue-vine"
            }
          },
          "end": "\\*/",
          "endCaptures": {
          ...
          "name": "comment.block.documentation.vue-vine",
          "patterns": [
            {
              "include": "#docblock"
            }
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "storage.type.internaldeclaration.vue-vine"
            },
            "3": {
              "name": "punctuation.decorator.internaldeclaration.vue-vine"
            }
          },
          "end": "\\*/",
          "endCaptures": {
          ...
          "name": "comment.block.vue-vine"
        },
        {
          "begin": "(^[\\t ]+)?((//)(?:\\s*((@)internal)(?=\\s|$))?)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.whitespace.comment.leading.vue-vine"
            },
            "2": {
              "name": "comment.line.double-slash.vue-vine"
            },
            "3": {
              "name": "punctuation.definition.comment.vue-vine"
            },
          ...
          "contentName": "comment.line.double-slash.vue-vine",
          "end": "(?=$)"
        }
      ]
    },
    "control-statement": {
      "patterns": [
        ...
        },
        {
          ...
          "name": "keyword.control.trycatch.vue-vine"
        },
        {
          "captures": {
            "1": {
              "name": "keyword.control.loop.vue-vine"
            },
            "2": {
              "name": "entity.name.label.vue-vine"
            }
          },
        ...
        },
        {
          ...
          "beginCaptures": {
            "0": {
              "name": "keyword.control.flow.vue-vine"
            }
          },
        ...
        },
        {
          ...
          "name": "keyword.control.switch.vue-vine"
        },
        {
        ...
        },
        {
          ...
          "name": "keyword.control.conditional.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(with)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "keyword.control.with.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(package)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "keyword.control.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(debugger)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "keyword.other.debugger.vue-vine"
        }
      ]
    },
    "decl-block": {
    ...
    "decorator": {
      ...
      "beginCaptures": {
        "0": {
          "name": "punctuation.decorator.vue-vine"
        }
      },
      "end": "(?=\\s)",
      "name": "meta.decorator.vue-vine",
      "patterns": [
        {
          "include": "#expression"
        }
      ...
      "patterns": [
        {
          ...
          "end": "(?=$|^|[,;=}]|((?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+))",
          "name": "meta.object-binding-pattern-variable.vue-vine",
          "patterns": [
            {
              "include": "#object-binding-pattern-const"
            },
        ...
        },
        {
          "begin": "(?<![:=]|^of|[^$._[:alnum:]]of|^in|[^$._[:alnum:]]in)\\s*(?=\\[)",
          "end": "(?=$|^|[,;=}]|((?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+))",
          "name": "meta.array-binding-pattern-variable.vue-vine",
          "patterns": [
            {
              "include": "#array-binding-pattern-const"
            },
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "punctuation.definition.binding-pattern.object.vue-vine"
            }
          },
          "end": "}",
          "endCaptures": {
          ...
          "name": "meta.parameter.object-binding-pattern.vue-vine",
          "patterns": [
            {
        ...
        },
        {
          ...
          "name": "meta.paramter.array-binding-pattern.vue-vine",
          "patterns": [
            {
    ...
    "destructuring-variable-rest": {
      "captures": {
        ...
        "2": {
          "name": "meta.definition.variable.ts variable.other.readwrite.vue-vine"
        }
      },
      "match": "(?:(\\.\\.\\.)\\s*)?([$_[:alpha:]][$_[:alnum:]]*)"
    },
    "destructuring-variable-rest-const": {
      "captures": {
        ...
        "2": {
          "name": "meta.definition.variable.ts variable.other.constant.vue-vine"
        }
      },
      "match": "(?:(\\.\\.\\.)\\s*)?([$_[:alpha:]][$_[:alnum:]]*)"
    },
    "directives": {
      ...
      "end": "(?=$)",
      "name": "comment.line.triple-slash.directive.vue-vine",
      "patterns": [
        {
          "begin": "(<)(reference|amd-dependency|amd-module)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.tag.directive.vue-vine"
            },
            "2": {
              "name": "entity.name.tag.directive.vue-vine"
            }
          },
          "end": "/>",
          "endCaptures": {
          ...
          "name": "meta.tag.vue-vine",
          "patterns": [
            {
              "match": "path|types|no-default-lib|lib|name|resolution-mode",
              "name": "entity.other.attribute-name.directive.vue-vine"
            },
            {
              "match": "=",
              "name": "keyword.operator.assignment.vue-vine"
            },
            {
              "include": "#string"
            }
    ...
    "enum-declaration": {
      ...
      "beginCaptures": {
        ...
        "4": {
          "name": "storage.type.enum.vue-vine"
        },
        "5": {
          "name": "entity.name.type.enum.vue-vine"
        }
      },
      "end": "(?<=})",
      "name": "meta.enum.declaration.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "beginCaptures": {
                "0": {
                  "name": "variable.other.enummember.vue-vine"
                }
              },
              "end": "(?=[,}]|$)",
              "patterns": [
      ...
      "patterns": [
        {
          "captures": {
            ...
            "2": {
              "name": "keyword.control.as.vue-vine"
            },
            "3": {
              "name": "storage.type.namespace.vue-vine"
            },
            "4": {
              "name": "entity.name.type.module.vue-vine"
            }
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "keyword.control.type.vue-vine"
            },
            "3": {
              "name": "keyword.operator.assignment.vue-vine"
            },
            "4": {
              "name": "keyword.control.default.vue-vine"
            }
          },
          "end": "(?=$|;|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)",
          "name": "meta.export.default.vue-vine",
          "patterns": [
            {
              "include": "#interface-declaration"
            },
      ...
      "patterns": [
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "entity.name.function.ts variable.language.this.vue-vine"
            },
            "4": {
              "name": "entity.name.function.vue-vine"
            },
            "5": {
              "name": "keyword.operator.optional.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "variable.parameter.ts variable.language.this.vue-vine"
            },
            "4": {
              "name": "variable.parameter.vue-vine"
            },
        ...
        {
          "match": ",",
          "name": "punctuation.separator.parameter.vue-vine"
        },
        {
          "include": "#identifiers"
        },
    ...
    "expression-operators": {
      "patterns": [
        ...
        },
        {
          ...
          "endCaptures": {
            "0": {
              "name": "keyword.generator.asterisk.vue-vine"
            }
          },
          "patterns": [
            {
        ...
        },
        {
          ...
          "name": "keyword.operator.expression.delete.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))in(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))(?!\\()",
          "name": "keyword.operator.expression.in.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))of(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))(?!\\()",
          "name": "keyword.operator.expression.of.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))instanceof(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "keyword.operator.expression.instanceof.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))new(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "keyword.operator.new.vue-vine"
        },
        {
        ...
        },
        {
          ...
          "name": "keyword.operator.expression.void.vue-vine"
        },
        {
          "captures": {
            "1": {
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "keyword.control.satisfies.vue-vine"
            }
          },
        ...
        {
          "match": "\\.\\.\\.",
          "name": "keyword.operator.spread.vue-vine"
        },
        {
          "match": "(?:\\*|(?<!\\()/|[-%+])=",
          "name": "keyword.operator.assignment.compound.vue-vine"
        },
        {
          "match": "(?:[\\&^]|<<|>>>??|\\|)=",
          "name": "keyword.operator.assignment.compound.bitwise.vue-vine"
        },
        {
          "match": "<<|>>>?",
          "name": "keyword.operator.bitwise.shift.vue-vine"
        },
        {
          "match": "[!=]==?",
          "name": "keyword.operator.comparison.vue-vine"
        },
        {
          "match": "<=|>=|<>|[<>]",
          "name": "keyword.operator.relational.vue-vine"
        },
        {
          "captures": {
            "1": {
              "name": "keyword.operator.logical.vue-vine"
            },
            "2": {
              "name": "keyword.operator.assignment.compound.vue-vine"
            },
            "3": {
              "name": "keyword.operator.arithmetic.vue-vine"
            }
          },
          "match": "(?<=[$_[:alnum:]])(!)\\s*(?:(/=)|(/)(?![*/]))"
        },
        ...
        {
          "match": "[\\&^|~]",
          "name": "keyword.operator.bitwise.vue-vine"
        },
        {
          "match": "=",
          "name": "keyword.operator.assignment.vue-vine"
        ...
        {
          "match": "--",
          "name": "keyword.operator.decrement.vue-vine"
        },
        {
          "match": "\\+\\+",
          "name": "keyword.operator.increment.vue-vine"
        },
        {
          "match": "[-%*+/]",
          "name": "keyword.operator.arithmetic.vue-vine"
    ...
    "field-declaration": {
      ...
      "name": "meta.field.declaration.vue-vine",
      "patterns": [
        {
          "include": "#variable-initializer"
        },
        ...
        },
        {
          "captures": {
            "1": {
              "name": "meta.definition.property.ts entity.name.function.vue-vine"
            },
            "2": {
              "name": "keyword.operator.optional.vue-vine"
            },
            "3": {
              "name": "keyword.operator.definiteassignment.vue-vine"
            }
          },
        ...
        {
          "match": "#?[$_[:alpha:]][$_[:alnum:]]*",
          "name": "meta.definition.property.ts variable.object.property.vue-vine"
        },
        {
          "match": "\\?",
          "name": "keyword.operator.optional.vue-vine"
    ...
    "for-loop": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "beginCaptures": {
            "0": {
              "name": "meta.brace.round.vue-vine"
            }
          },
          "end": "\\)",
          "endCaptures": {
          ...
          "patterns": [
            {
              ...
              "name": "meta.function-call.vue-vine",
              "patterns": [
                {
    ...
    "function-call-optionals": {
      "patterns": [
        {
          "match": "\\?\\.",
          "name": "meta.function-call.ts punctuation.accessor.optional.vue-vine"
        },
        {
          "match": "!",
          "name": "meta.function-call.ts keyword.operator.definiteassignment.vue-vine"
        }
      ]
    },
    ...
    "function-declaration": {
      ...
      "beginCaptures": {
        ...
        "4": {
          "name": "storage.type.function.vue-vine"
        },
        "5": {
          "name": "keyword.generator.asterisk.vue-vine"
        },
        "6": {
          "name": "meta.definition.function.ts entity.name.function.vue-vine"
        }
      },
      "end": "(?=;|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)|(?<=})",
      "name": "meta.function.vue-vine",
      "patterns": [
        {
    ...
    "function-expression": {
      ...
      "end": "(?=;)|(?<=})",
      "name": "meta.function.expression.vue-vine",
      "patterns": [
        {
          "include": "#function-name"
        },
    ...
    "function-parameters": {
      ...
      "beginCaptures": {
        "0": {
          "name": "punctuation.definition.parameters.begin.vue-vine"
        }
      },
      "end": "\\)",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.parameters.end.vue-vine"
        }
      },
      "name": "meta.parameters.vue-vine",
      "patterns": [
        {
      ...
      "patterns": [
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "variable.other.constant.property.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "variable.other.property.vue-vine"
            }
          },
        ...
        },
        {
          ...
          "name": "variable.other.constant.vue-vine"
        },
        {
          "match": "[$_[:alpha:]][$_[:alnum:]]*",
          "name": "variable.other.readwrite.vue-vine"
        }
      ]
    },
    "if-statement": {
      "patterns": [
        {
          ...
          "patterns": [
            ...
            {
              "begin": "(?<=\\))\\s*/(?![*/])(?=(?:[^/\\[\\\\]|\\\\.|\\[([^]\\\\]|\\\\.)*])+/([dgimsuy]+|(?![*/])|(?=/\\*))(?!\\s*[$0-9A-Z_a-z]))",
              "beginCaptures": {
                "0": {
                  "name": "punctuation.definition.string.begin.vue-vine"
                }
              },
              "end": "(/)([dgimsuy]*)",
              "endCaptures": {
                "1": {
                  "name": "punctuation.definition.string.end.vue-vine"
                },
                "2": {
                  "name": "keyword.other.vue-vine"
                }
              },
              "name": "string.regexp.vue-vine",
              "patterns": [
                {
                  "include": "#regexp"
                }
    ...
    "import-declaration": {
      ...
      "beginCaptures": {
        ...
        "3": {
          "name": "keyword.control.import.vue-vine"
        },
        "4": {
          "name": "keyword.control.type.vue-vine"
        }
      ...
      "patterns": [
        ...
        },
        {
          ...
          "endCaptures": {
            "0": {
              "name": "keyword.control.from.vue-vine"
            }
          },
          "patterns": [
            {
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            ...
            "5": {
              "name": "variable.other.readwrite.alias.vue-vine"
            },
            "6": {
              "name": "keyword.operator.assignment.vue-vine"
            },
            "7": {
              "name": "keyword.control.require.vue-vine"
            },
            "8": {
              "name": "meta.brace.round.vue-vine"
            }
          ...
          "name": "meta.import-equals.external.vue-vine",
          "patterns": [
            {
              "include": "#comment"
            },
        ...
        },
        {
          ...
          "end": "(?=;|$|^)",
          "name": "meta.import-equals.internal.vue-vine",
          "patterns": [
            {
              "include": "#single-line-comment-consuming-line-ending"
            },
    ...
    "import-export-assert-clause": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.control.assert.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.block.vue-vine"
        }
      ...
      "patterns": [
        ...
        },
        {
          ...
          "name": "meta.object-literal.key.vue-vine"
        },
        {
          "match": ":",
          "name": "punctuation.separator.key-value.vue-vine"
        }
      ]
    },
    "import-export-block": {
      ...
      "patterns": [
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "constant.language.import-export-all.vue-vine"
            },
            "4": {
              "name": "variable.other.readwrite.vue-vine"
            },
    ...
    "indexer-declaration": {
      ...
      "name": "meta.indexer.declaration.vue-vine",
      "patterns": [
        {
          "include": "#type-annotation"
        }
    ...
    "indexer-mapped-type-declaration": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.operator.type.modifier.vue-vine"
        },
        "2": {
          "name": "storage.modifier.vue-vine"
        },
        ...
        "4": {
          "name": "entity.name.type.vue-vine"
        },
        "5": {
          "name": "keyword.operator.expression.in.vue-vine"
        }
      ...
      "name": "meta.indexer.mappedtype.declaration.vue-vine",
      "patterns": [
        {
          "captures": {
            "1": {
    ...
    "interface-declaration": {
      ...
      "beginCaptures": {
        ...
        "4": {
          "name": "storage.type.interface.vue-vine"
        }
      },
      "end": "(?<=})",
      "name": "meta.interface.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
        ...
        },
        {
          "captures": {
            "0": {
              "name": "entity.name.type.interface.vue-vine"
            }
          },
          "match": "[$_[:alpha:]][$_[:alnum:]]*"
        },
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "punctuation.separator.label.vue-vine"
            }
          },
          "end": "(?<=})",
          "patterns": [
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            ...
            "5": {
              "name": "storage.type.vue-vine"
            }
          },
          "end": "(?=[,;}]|$)|(?<=})",
          "name": "meta.method.declaration.vue-vine",
          "patterns": [
            {
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "5": {
              "name": "storage.type.property.vue-vine"
            },
            "6": {
              "name": "keyword.generator.asterisk.vue-vine"
            }
    ...
    "method-declaration-name": {
      ...
      "patterns": [
        ...
        {
          "match": "[$_[:alpha:]][$_[:alnum:]]*",
          "name": "meta.definition.method.ts entity.name.function.vue-vine"
        },
        {
          "match": "\\?",
          "name": "keyword.operator.optional.vue-vine"
    ...
    "namespace-declaration": {
      ...
      "end": "(?<=})|(?=;|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)",
      "name": "meta.namespace.declaration.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
    ...
    "null-literal": {
      ...
      "name": "constant.language.null.vue-vine"
    },
    "numeric-literal": {
      "patterns": [
        {
          "captures": {
            "1": {
              "name": "storage.type.numeric.bigint.vue-vine"
            }
          },
          "match": "\\b(?<!\\$)0[Xx]\\h[_\\h]*(n)?\\b(?!\\$)",
          "name": "constant.numeric.hex.vue-vine"
        },
        {
          "captures": {
            "1": {
          ...
          "name": "constant.numeric.binary.vue-vine"
        },
        {
          "captures": {
            "1": {
          ...
          "name": "constant.numeric.octal.vue-vine"
        },
        {
          "captures": {
            "0": {
              "name": "constant.numeric.decimal.vue-vine"
            },
            "1": {
              "name": "meta.delimiter.decimal.period.vue-vine"
            },
            "10": {
              "name": "meta.delimiter.decimal.period.vue-vine"
            },
      ...
      "patterns": [
        {
          ...
          "name": "constant.language.nan.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))Infinity(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))",
          "name": "constant.language.infinity.vue-vine"
        }
      ]
    },
    ...
    "object-binding-element-propertyName": {
      ...
      "endCaptures": {
        "0": {
          "name": "punctuation.destructuring.vue-vine"
        }
      },
      "patterns": [
        {
        ...
        {
          "match": "([$_[:alpha:]][$_[:alnum:]]*)",
          "name": "variable.object.property.vue-vine"
        }
      ]
    },
      ...
      "patterns": [
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "variable.other.constant.object.property.vue-vine"
            },
            "4": {
              "name": "variable.other.object.property.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            "1": {
              "name": "variable.other.constant.object.vue-vine"
            },
            "2": {
              "name": "variable.other.object.vue-vine"
            }
          },
    ...
    "object-member": {
      "patterns": [
        ...
        },
        {
          "begin": "(?=\\[)",
          "end": "(?=:)|((?<=])(?=\\s*[(<]))",
          "name": "meta.object.member.ts meta.object-literal.key.vue-vine",
          "patterns": [
            {
              "include": "#comment"
            },
        ...
        },
        {
          ...
          "match": "(?![$_[:alpha:]])(\\d+)\\s*(?=(/\\*([^*]|(\\*[^/]))*\\*/\\s*)*:)",
          "name": "meta.object.member.vue-vine"
        },
        {
          "captures": {
            "0": {
        ...
        },
        {
          ...
          "beginCaptures": {
            "0": {
              "name": "meta.object-literal.key.ts punctuation.separator.key-value.vue-vine"
            }
          },
          "end": "(?=[,}])",
          "name": "meta.object.member.vue-vine",
      ...
      "patterns": [
        {
          ...
          "end": "(?=[),])|(?==[^>])",
          "name": "meta.type.annotation.vue-vine",
          "patterns": [
            {
              "include": "#type"
            }
    ...
    "possibly-arrow-return-type": {
      ...
      "beginCaptures": {
        "1": {
          "name": "meta.arrow.ts meta.return.type.arrow.ts keyword.operator.type.annotation.vue-vine"
        }
      },
      "contentName": "meta.arrow.ts meta.return.type.arrow.vue-vine",
      "end": "(?==>|\\{|^(\\s*(export|function|class|interface|let|var|const|import|enum|namespace|module|type|abstract|declare)\\s+))",
      "patterns": [
        {
          "include": "#arrow-return-type-body"
    ...
    "punctuation-comma": {
      "match": ",",
      "name": "punctuation.separator.comma.vue-vine"
    },
    "punctuation-semicolon": {
      "match": ";",
      "name": "punctuation.terminator.statement.vue-vine"
    },
    "qstring-double": {
      "begin": "\"",
      "beginCaptures": {
      ...
      "endCaptures": {
        ...
        "2": {
          "name": "invalid.illegal.newline.vue-vine"
        }
      },
      "name": "string.quoted.double.vue-vine",
      "patterns": [
        {
    ...
    "qstring-single": {
      ...
      "name": "string.quoted.single.vue-vine",
      "patterns": [
        {
          "include": "#string-character-escape"
        }
    ...
    "regex": {
      "patterns": [
        {
          "begin": "(?<!\\+\\+|--|})(?<=[!(+,:=?\\[]|^return|[^$._[:alnum:]]return|^case|[^$._[:alnum:]]case|=>|&&|\\|\\||\\*/)\\s*(/)(?![*/])(?=(?:[^()/\\[\\\\]|\\\\.|\\[([^]\\\\]|\\\\.)+]|\\(([^)\\\\]|\\\\.)+\\))+/([dgimsuy]+|(?![*/])|(?=/\\*))(?!\\s*[$0-9A-Z_a-z]))",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.vue-vine"
            }
        ...
        {
          "begin": "((?<![]$)_[:alnum:]]|\\+\\+|--|}|\\*/)|((?<=^return|[^$._[:alnum:]]return|^case|[^$._[:alnum:]]case))\\s*)/(?![*/])(?=(?:[^/\\[\\\\]|\\\\.|\\[([^]\\\\]|\\\\.)*])+/([dgimsuy]+|(?![*/])|(?=/\\*))(?!\\s*[$0-9A-Z_a-z]))",
          "beginCaptures": {
            "0": {
              "name": "punctuation.definition.string.begin.vue-vine"
            }
      ...
      "patterns": [
        {
          ...
          "end": "(?<![\\&:|])(?=$|^|[,;{}]|//)",
          "name": "meta.return.type.vue-vine",
          "patterns": [
            {
    ...
    "shebang": {
      ...
      "match": "\\A(#!).*(?=$)",
      "name": "comment.line.shebang.vue-vine"
    },
    ...
    "string": {
      "patterns": [
        ...
        {
          "include": "#vine-template"
        },
        {
          "include": "#vine-style-css"
        },
        {
          "include": "#vine-style-scss"
        },
        {
          "include": "#vine-style-sass"
        },
        {
          "include": "#vine-style-less"
        },
        {
          "include": "#vine-style-stylus"
        },
        {
          "include": "#template"
        }
    ...
    "string-character-escape": {
      ...
      "name": "constant.character.escape.vue-vine"
    },
    "super-literal": {
      "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))super\\b(?!\\$)",
      "name": "variable.language.super.vue-vine"
    },
    "support-function-call-identifiers": {
      "patterns": [
        ...
        },
        {
          ...
          "name": "keyword.operator.expression.import.vue-vine"
        }
      ]
    },
    "support-objects": {
      "patterns": [
        {
          ...
          "name": "variable.language.arguments.vue-vine"
        },
        {
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(Promise)\\b(?!\\$)",
          "name": "support.class.promise.vue-vine"
        },
        {
          "captures": {
            "1": {
            ...
            "4": {
              "name": "support.variable.property.importmeta.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            ...
            "4": {
              "name": "support.variable.property.target.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            ...
            "3": {
              "name": "support.variable.property.vue-vine"
            },
            "4": {
              "name": "support.constant.vue-vine"
            }
          },
        ...
        },
        {
          "captures": {
            "1": {
              "name": "support.type.object.module.vue-vine"
            },
            "2": {
              "name": "support.type.object.module.vue-vine"
            },
    ...
    "switch-statement": {
      ...
      "name": "switch-statement.expr.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
        {
          ...
          "name": "switch-expression.expr.vue-vine",
          "patterns": [
            {
              "include": "#expression"
            }
        ...
        },
        {
          ...
          "end": "(?=})",
          "name": "switch-block.expr.vue-vine",
          "patterns": [
            {
              ...
              "end": "(?=:)",
              "name": "case-clause.expr.vue-vine",
              "patterns": [
                {
                  "include": "#expression"
                }
            ...
            },
            {
              ...
              "beginCaptures": {
                "1": {
                  "name": "case-clause.expr.ts punctuation.definition.section.case-statement.vue-vine"
                },
                "2": {
                  "name": "meta.block.ts punctuation.definition.block.vue-vine"
                }
              },
              "contentName": "meta.block.vue-vine",
              "end": "}",
              "endCaptures": {
                "0": {
                  "name": "meta.block.ts punctuation.definition.block.vue-vine"
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.tagged-template.vue-vine"
            },
            "2": {
              "name": "punctuation.definition.string.template.begin.vue-vine"
            }
          },
          "contentName": "string.template.vue-vine",
          "end": "`",
          "endCaptures": {
            "0": {
              "name": "punctuation.definition.string.template.end.vue-vine"
            }
          },
          "patterns": [
            {
    ...
    "template-substitution-element": {
      ...
      "beginCaptures": {
        "0": {
          "name": "punctuation.definition.template-expression.begin.vue-vine"
        }
      },
      "contentName": "meta.embedded.line.vue-vine",
      "end": "}",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.template-expression.end.vue-vine"
        }
      },
      "name": "meta.template.expression.vue-vine",
      "patterns": [
        {
          "include": "#expression"
        }
      ...
      "patterns": [
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "string.template.ts punctuation.definition.string.template.begin.vue-vine"
            }
          },
          "contentName": "string.template.vue-vine",
          "end": "`",
          "endCaptures": {
            "0": {
              "name": "string.template.ts punctuation.definition.string.template.end.vue-vine"
            }
          },
          "patterns": [
            {
    ...
    "ternary-expression": {
      ...
      "beginCaptures": {
        "1": {
          "name": "keyword.operator.ternary.vue-vine"
        }
      },
      "end": "\\s*(:)",
      "endCaptures": {
    ...
    "text-vue-html": {
      "patterns": [
        ...
        },
        {
          ...
          "patterns": [
            {
              "include": "#vue-html-tag-generic-attribute"
            },
            {
              "include": "#vue-html-string-double-quoted"
            },
            {
              "include": "#vue-html-string-single-quoted"
            }
          ]
        },
        {
    ...
    "this-literal": {
      ...
      "name": "variable.language.this.vue-vine"
    },
    "type": {
      "patterns": [
        {
    ...
    "type-alias-declaration": {
      ...
      "beginCaptures": {
        ...
        "3": {
          "name": "storage.type.type.vue-vine"
        },
        "4": {
          "name": "entity.name.type.alias.vue-vine"
        }
      },
      "end": "(?=[;}]|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)",
      "name": "meta.type.declaration.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "keyword.control.intrinsic.vue-vine"
            }
          },
          "end": "(?=[;}]|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)",
          "patterns": [
    ...
    "type-arguments": {
      ...
      "beginCaptures": {
        "0": {
          "name": "punctuation.definition.typeparameters.begin.vue-vine"
        }
      },
      "end": ">",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.typeparameters.end.vue-vine"
        }
      },
      "name": "meta.type.parameters.vue-vine",
      "patterns": [
        {
      ...
      "patterns": [
        {
          "captures": {
            "0": {
              "name": "keyword.operator.type.vue-vine"
            }
          },
    ...
    "type-builtin-literals": {
      ...
      "name": "support.type.builtin.vue-vine"
    },
    "type-conditional": {
      "patterns": [
        {
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "1": {
              "name": "meta.type.constructor.ts storage.modifier.vue-vine"
            },
            "2": {
              "name": "meta.type.constructor.ts keyword.control.new.vue-vine"
            }
          },
          "end": "(?<=>)",
          "patterns": [
        ...
        },
        {
          ...
          "beginCaptures": {
            ...
            "2": {
              "name": "keyword.control.new.vue-vine"
            }
          },
          "end": "(?<=\\))",
          "name": "meta.type.constructor.vue-vine",
          "patterns": [
            {
              "include": "#function-parameters"
            }
        ...
        },
        {
          "begin": "((?=\\(\\s*((\\))|(\\.\\.\\.)|([$_[:alnum:]]+\\s*(([,:=?])|(\\)\\s*=>))))))",
          "end": "(?<=\\))",
          "name": "meta.type.function.vue-vine",
          "patterns": [
            {
              "include": "#function-parameters"
            }
      ...
      "patterns": [
        {
          ...
          "end": "(?<!=>)(?<![\\&|])(?=[]),:;=>?{}]|//|$)",
          "name": "meta.type.function.return.vue-vine",
          "patterns": [
            {
      ...
      "patterns": [
        {
          "captures": {
            "1": {
              "name": "keyword.operator.expression.infer.vue-vine"
            },
            "2": {
              "name": "entity.name.type.vue-vine"
            },
            "3": {
              "name": "keyword.operator.expression.extends.vue-vine"
            }
          },
          "match": "(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(infer)\\s+([$_[:alpha:]][$_[:alnum:]]*)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))(?:\\s+(extends)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.)))?",
          "name": "meta.type.infer.vue-vine"
        }
      ]
    },
    "type-name": {
      "patterns": [
        {
          ...
          "captures": {
            ...
            "4": {
              "name": "meta.type.parameters.ts punctuation.definition.typeparameters.begin.vue-vine"
            }
          },
          "contentName": "meta.type.parameters.vue-vine",
          "end": "(>)",
          "endCaptures": {
            "1": {
              "name": "meta.type.parameters.ts punctuation.definition.typeparameters.end.vue-vine"
            }
          },
          "patterns": [
            {
    ...
    "type-object": {
      ...
      "name": "meta.object.type.vue-vine",
      "patterns": [
        {
          "include": "#comment"
        },
    ...
    "type-operators": {
      "patterns": [
        ...
        },
        {
          ...
          "name": "keyword.operator.expression.keyof.vue-vine"
        },
        {
          "match": "([:?])",
          "name": "keyword.operator.ternary.vue-vine"
    ...
    "type-paren-or-function-parameters": {
      ...
      "name": "meta.type.paren.cover.vue-vine",
      "patterns": [
        {
          "captures": {
            "1": {
      ...
      "patterns": [
        {
          "captures": {
            "1": {
              "name": "keyword.operator.type.asserts.vue-vine"
            },
            "2": {
              "name": "variable.parameter.ts variable.language.this.vue-vine"
            },
            ...
            "4": {
              "name": "keyword.operator.expression.is.vue-vine"
            }
          },
    ...
    "type-primitive": {
      ...
      "name": "support.type.primitive.vue-vine"
    },
    "type-string": {
      "patterns": [
        {
    ...
    "typeof-operator": {
      ...
      "beginCaptures": {
        "0": {
          "name": "keyword.operator.expression.typeof.vue-vine"
        }
      },
    ...
    "undefined-literal": {
      ...
      "name": "constant.language.undefined.vue-vine"
    },
    "var-expr": {
      "patterns": [
        {
          "begin": "(?=(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:\\b(export)\\s+)?(?:\\b(declare)\\s+)?\\b(var|let)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.)))",
          "end": "(?!(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:\\b(export)\\s+)?(?:\\b(declare)\\s+)?\\b(var|let)(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.)))((?=^|[;}]|((?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|;|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)|((?<!^let|[^$._[:alnum:]]let|^var|[^$._[:alnum:]]var)(?=\\s*$)))",
          "name": "meta.var.expr.vue-vine",
          "patterns": [
            {
        ...
        },
        {
          ...
          "end": "(?!(?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:\\b(export)\\s+)?(?:\\b(declare)\\s+)?\\b(const(?!\\s+enum\\b))(?![$_[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.)))((?=^|[;}]|((?<![$_[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|;|^\\s*$|^\\s*(?:abstract|async|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|var|while)\\b)|((?<!(?:^|[^$._[:alnum:]])const)(?=\\s*$)))",
          "name": "meta.var.expr.vue-vine",
          "patterns": [
            {
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "1": {
              "name": "meta.definition.variable.ts variable.other.constant.ts entity.name.function.vue-vine"
            }
          },
          ...
          "name": "meta.var-single-variable.expr.vue-vine",
          "patterns": [
            {
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "1": {
              "name": "meta.definition.variable.ts entity.name.function.vue-vine"
            },
            "2": {
              "name": "keyword.operator.definiteassignment.vue-vine"
            }
    ...
    "vine-style-css": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-css.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-css.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-css.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-css.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-style-less": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-less.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-less.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-less.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-less.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-style-postcss": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-postcss.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-postcss.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-postcss.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-postcss.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-style-sass": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-sass.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-sass.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-sass.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-sass.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-style-scss": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-scss.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-scss.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-scss.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-scss.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-style-stylus": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-style-stylus.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-style-stylus.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-style-stylus.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-style-stylus.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vine-template": {
      ...
      "beginCaptures": {
        "1": {
          "name": "entity.name.function.vine-template.vue-vine"
        },
        "2": {
          "name": "punctuation.definition.string.vine-template.begin.vue-vine"
        }
      },
      "contentName": "variable.vine-template.vue-vine",
      "end": "`",
      "endCaptures": {
        "0": {
          "name": "punctuation.definition.string.vine-template.end.vue-vine"
        }
      },
      "patterns": [
        {
    ...
    "vue-html-string-double-quoted": {
      ...
      "patterns": [
        ...
        {
          "include": "#vue-html-entities"
        }
      ]
    },
    "vue-html-string-single-quoted": {
      "begin": "'",
      "beginCaptures": {
        "0": {
          "name": "punctuation.definition.string.begin.html"
    ...
    "vue-html-tag-generic-attribute": {
      "match": "(?<=[^=])\\b([-0-:A-Z_a-z]+)",
      "name": "entity.other.attribute-name.html"
    },
    "vue-html-tag-id-attribute": {
      "begin": "\\b(id)\\b\\s*(=)",
      "captures": {
        "1": {
    ...
    "vue-html-tag-stuff": {
      "patterns": [
        {
          "include": "#vue-html-vue-directives"
        },
        {
          "include": "#vue-html-tag-id-attribute"
        },
        {
          "include": "#vue-html-tag-generic-attribute"
        },
        ...
        {
          "include": "#vue-html-unquoted-attribute"
        }
      ]
    },
    "vue-html-unquoted-attribute": {
      "match": "(?<==)(?:[^\"'/<>\\s]|/(?!>))+",
      "name": "string.unquoted.html"
    },
    "vue-html-vue-directives": {
      "begin": "(?:\\b(v-)|([#:@]))([-0-9A-Z_a-z]+)(?::([-A-Z_a-z]+))?(?:\\.([-A-Z_a-z]+))*\\s*(=)",
      "captures": {
        "1": {
          "name": "entity.other.attribute-name.html"
        },
