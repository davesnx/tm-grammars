  ...
  "repository": {
          ...
          "patterns": [
            {
              ...
              "patterns": [
                ...
                {
                  "match": "--|-?(?:[A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))(?:[-A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}\\d]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))*",
    ...
    "color-functions": {
      "patterns": [
        ...
        {
          "begin": "\\b(hsla?|hwb|oklab|oklch|lab|lch)(?=\\()",
          "beginCaptures": {
            "1": {
              "name": "support.function.color.less"
            }
          ...
          "patterns": [
            {
              ...
              "patterns": [
                ...
                {
                  "match": "(([cm])?m|in|p([ctx])|m?s|g?rad|deg|turn|%|r?em|ex|ch)",
                  "name": "keyword.other.unit.less"
                }
              ]
            }
    ...
    "media-query": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "patterns": [
            {
              "begin": "(--|-?(?:[A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))(?:[-A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}\\d]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))*)\\s*(?=[):])",
              "beginCaptures": {
                "0": {
    ...
    "pseudo-selectors": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "(::?)(-\\w+-)(--|-?(?:[A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))(?:[-A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}\\d]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))*)\\b",
          "name": "entity.other.attribute-name.pseudo-element.less"
        }
      ]
    },
      ...
      "patterns": [
        ...
        },
        {
          ...
          "patterns": [
            ...
            {
              "begin": "(-[-\\w]+?-)((?:[A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))(?:[-A-Z_a-z·À-ÖØ-öø-ͽͿ-῿‌‍‿⁀⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-\\x{EFFFF}\\d]|\\\\(?:\\N|\\H|\\h{1,6}[R\\s]))*)\\b",
              "beginCaptures": {
                "0": {
                  "name": "support.type.property-name.less"
                },
    ...
    "time-type": {
      ...
      "match": "(?i:[-+]?(?:\\d*\\.\\d+(?:[Ee][-+]?\\d+)*|[-+]?\\d+)(m??s))\\b",
      "name": "constant.numeric.less"
    },
    "transform-functions": {
      "patterns": [
        {
          "begin": "\\b((?:matrix|scale)(?:3d|))(?=\\()",
          "beginCaptures": {
            "0": {
    ...
    "unicode-range": {
      ...
      "match": "(?i)(u\\+)([0-9?a-f]{1,6}(?:(-)[0-9a-f]{1,6})?)",
