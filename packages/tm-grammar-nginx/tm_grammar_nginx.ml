...
let json =
  ...
  "patterns": [
    ...
    {
      "begin": "\\b(map) +(\\$)([0-9A-Z_a-z]+) +(\\$)([0-9A-Z_a-z]+) *\\{",
      "beginCaptures": {
        "1": {
          "name": "storage.type.directive.context.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(accept_)(mutex(?:|_delay))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(types_)(hash_(?:bucket|max)_size)([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(variables_)(hash_(?:bucket|max)_size)([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(ancient_)(browser(?:|_value))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(modern_)(browser(?:|_value))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(image_)(filter(?:|_buffer|_interlace|_jpeg_quality|_sharpen|_transparency|_webp_quality))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(map_)(hash_(?:bucket|max)_size)([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(real_)(ip_(?:header|recursive))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(referer_)(hash_(?:bucket|max)_size)([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(secure_)(link(?:|_md5|_secret))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(session_)(log(?:|_format|_zone))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(sub_)(filter(?:|_last_modified|_once|_types))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(health_)(check(?:|_timeout))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
    ...
    {
      "begin": "([\"'\\s]|^)(zone_)(sync_(?:buffers|connect_retry_interval|connect_timeout|interval|recv_buffer_size|server|ssl|ssl_certificate|ssl_certificate_key|ssl_ciphers|ssl_conf_command|ssl_crl|ssl_name|ssl_password_file|ssl_protocols|ssl_server_name|ssl_trusted_certificate|ssl_verify|ssl_verify_depth|timeout))([\"'\\s]|$)",
      "beginCaptures": {
        "1": {
          "name": "keyword.directive.nginx"
        },
      ...
      "patterns": [
        {
          ...
          "match": "(?:^|\\s)(weight|max_conn|max_fails|fail_timeout|slow_start)(=)(\\d[.\\d]*[BDGHKMSTbdghkmst]?)(?:[;\\s]|$)"
        },
        {
          "include": "#values"
        }
    ...
    "values": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "(?<=\\G|\\s)(=?[0-9][.0-9]*[BDGHKMSTbdghkmst]?)(?=[\\t ;])"
        },
        {
