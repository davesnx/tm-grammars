  ...
  "repository": {
          ...
          "patterns": [
            {
              ...
              "end": "(?i)\\s*\\b(?:(end\\s*function)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
              "endCaptures": {
                "1": {
    ...
    "intrinsic-subroutines": {
      "patterns": [
        ...
        {
          "begin": "(?i)\\G\\s*\\b(ieee_([gs]et)_(rounding|underflow)_mode)\\s*(?=\\()",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.subroutine.fortran"
            },
        ...
        {
          "begin": "(?i)\\G\\s*\\b(ieee_([gs]et)_(flag|halting_mode|status))\\s*(?=\\()",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.subroutine.fortran"
            },
        ...
        {
          "begin": "(?i)\\G\\s*\\b(c_f_(p(?:|rocp)ointer))\\s*(?=\\()",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.subroutine.fortran"
            },
    ...
    "logical-operators": {
      "patterns": [
        {
          "match": "(?i)(\\s*\\.(and|eqv??|le|lt|ge|gt|ne|neqv|not|or)\\.)",
    ...
    "module-definition": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "end": "(?i)\\b(?:(end\\s*module)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
          "endCaptures": {
            "1": {
    ...
    "named-control-constructs": {
      ...
      "end": "(?i)(?!\\s*\\b(?:associate|block(?!\\s*data)|critical|do|forall|if|select\\s*case|select\\s*type|select\\s*rank|where)\\b)(?:\\b(\\1)\\b)?([^\\n!;\\s]*?)?(?=\\s*[\\n!;])",
      "endCaptures": {
        "1": {
    ...
    "numeric-constant": {
      "match": "(?i)[-+]?(\\b\\d+\\.?\\d*|\\.\\d+)(_\\w+|d[-+]?\\d+|e[-+]?\\d+(_\\w+)?)?(?![_a-z])",
      "name": "constant.numeric.fortran"
    },
    "numeric-type": {
      "patterns": [
          ...
          "patterns": [
            {
              ...
              "end": "(?i)\\s*\\b(?:(end\\s*procedure)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
              "endCaptures": {
                "1": {
    ...
    "program-definition": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "end": "(?i)\\b(?:(end\\s*program)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
          "endCaptures": {
            "1": {
    ...
    "submodule-definition": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "end": "(?i)\\s*\\b(?:(end\\s*submodule)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
          "endCaptures": {
            "1": {
          ...
          "patterns": [
            {
              ...
              "end": "(?i)\\b(?:(end\\s*subroutine)(?:\\s+([_a-z]\\w*))?|(end))\\b\\s*([^\\n!;]+)?(?=[\\n!;])",
              "endCaptures": {
                "1": {
