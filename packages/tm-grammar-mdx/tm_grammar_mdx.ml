...
let json = {json|{
  ...
  "repository": {
    ...
    "commonmark-code-fenced-apib": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:api-blueprint|(?:.*\\.)?apib))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
    ...
    "commonmark-code-fenced-c": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:dtrace|dtrace-script|oncrpc|rpc|rpcgen|unified-parallel-c|x-bitmap|x-pixmap|xdr|(?:.*\\.)?(?:c|cats|h|idc|opencl|upc|xbm|xpm|xs)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-clojure": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:clojure|rouge|(?:.*\\.)?(?:boot|cl2|cljc??|cljs|cljs\\.hl|cljscm|cljx|edn|hic|rg|wisp)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-coffee": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:coffee-script|coffeescript|(?:.*\\.)?(?:_coffee|cjsx|coffee|cson|em|emberscript|iced)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-console": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:py(?:con|thon-console)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-cpp": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:ags|ags-script|asymptote|c\\+\\+|edje-data-collection|game-maker-language|swig|(?:.*\\.)?(?:asc|ash|asy|c\\+\\+|cc|cpp??|cppm|cxx|edc|gml|h\\+\\+|hh|hpp|hxx|inl|ino|ipp|ixx|metal|re|tcc|tpp|txx)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-dockerfile": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:(?:contain|(?:.*\\.)?dock)erfile))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-gitconfig": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:git-config|gitmodules|(?:.*\\.)?gitconfig))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-haskell": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:c2hs|c2hs-haskell|frege|haskell|(?:.*\\.)?(?:chs|dhall|hs|hs-boot|hsc)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-ini": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:altium|altium-designer|dosini|(?:.*\\.)?(?:cnf|dof|ini|lektorproject|outjob|pcbdoc|prefs|prjpcb|properties|schdoc|url)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-java": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:chuck|unrealscript|(?:.*\\.)?(?:ck|java??|jsh|uc)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-json": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:ecere-projects|ipython-notebook|jupyter-notebook|max|max/msp|maxmsp|oasv2-json|oasv3-json|(?:.*\\.)?(?:4dform|4dproject|avsc|epj|geojson|gltf|har|ice|ipynb|json|json-tmlanguage|jsonl|maxhelp|maxpat|maxproj|mcmeta|mxt|pat|sarif|tfstate|tfstate\\.backup|topojson|webapp|webmanifest|yyp??)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-kotlin": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:gradle-kotlin-dsl|kotlin|(?:.*\\.)?(?:gradle\\.kts|ktm??|kts)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-makefile": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:bsdmake|mf|(?:.*\\.)?m(?:ake??|akefile|k|kfile)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-md": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:md|pandoc|rmarkdown|(?:.*\\.)?(?:livemd|markdown|mdown|mdwn|mkdn??|mkdown|qmd|rmd|ronn|scd|workbook)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-perl": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:cperl|(?:.*\\.)?(?:cgi|perl|ph|plx??|pm|psgi|t)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-python": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:bazel|easybuild|python3??|rusthon|snakemake|starlark|xonsh|(?:.*\\.)?(?:bzl|eb|gypi??|lmi|py3??|pyde|pyi|pyp|pyt|pyw|rpy|sage|sagews|smk|snakefile|spec|tac|wsgi|xpy|xsh)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-r": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:rscript|splus|(?:.*\\.)?r(?:|d|sx)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-raku": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:perl-6|perl6|pod-6|(?:.*\\.)?(?:6pl|6pm|nqp|p6l??|p6m|pl6|pm6|pod6??|raku|rakumod)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-ruby": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:jruby|macruby|(?:.*\\.)?(?:builder|druby|duby|eye|gemspec|god|jbuilder|mirah|mspec|pluginspec|podspec|prawn|rabl|rake|rbi??|rbuild|rbw|rbx|ru|ruby|thor|watchr)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-shell-session": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:bash-session|console|shellsession|(?:.*\\.)?sh-session))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-sql": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:plpgsql|sqlpl|(?:.*\\.)?(?:cql|db2|ddl|mysql|pgsql|prc|sql|tab|udf|viw)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-vbnet": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:fb|freebasic|realbasic|vb-\\.net|vb\\.net|vbnet|vbscript|visual-basic|visual-basic-\\.net|(?:.*\\.)?(?:bi|rbbas|rbfrm|rbmnu|rbres|rbtbar|rbuistate|vb|vbhtml|vbs)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "commonmark-code-fenced-yaml": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[\\t ]*(`{3,})[\\t ]*((?i:jar-manifest|kaitai-struct|oasv2-yaml|oasv3-yaml|unity3d-asset|yaml|yml|(?:.*\\.)?(?:anim|asset|ksy|lkml|lookml|mat|meta|mir|prefab|raml|reek|rviz|sublime-syntax|syntax|unity|yaml-tmlanguage|yaml\\.sed|yml\\.mysql)))(?:[\\t ]+([^\\n\\r`]+))?[\\t ]*$",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.mdx"
            },
    ...
    "extension-gfm-autolink-literal": {
      "patterns": [
        ...
        {
          "match": "(?<=^|[^/A-Za-z])(?i:mailto:|xmpp:)?[-+.0-9A-Z_a-z]+@(?:(?:[0-9A-Za-z]|[-_](?![!\"')*,.:;<?_~]*(?:[<\\s]|][\\t\\n (\\[])))+\\.(?![!\"')*,.:;<?_~]*(?:[<\\s]|][\\t\\n (\\[])))+(?:[A-Za-z]|[-_](?![!\"')*,.:;<?_~]*(?:[<\\s]|][\\t\\n (\\[])))+",
    ...
    "extension-github-mention": {
      ...
      "match": "(?<![0-9A-Z_-z])(@)([0-9A-Za-z][-0-9A-Za-z]{0,38}(?:/[0-9A-Za-z][-0-9A-Za-z]{0,38})?)(?![0-9A-Z_-z])",
      ...
      "patterns": [
        {
          ...
          "match": "(?<![0-9A-Z_a-z])(?:((?i:ghsa-|cve-))([0-9A-Za-z]+)|((?i:gh-|#))([0-9]+))(?![0-9A-Z_a-z])",
        ...
        },
        {
          ...
          "match": "(?<![^\\t\\n\\r (@\\[{])([0-9A-Za-z][-0-9A-Za-z]{0,38}(?:/(?:\\.git[-0-9A-Z_a-z]|\\.(?!git)|[-0-9A-Z_a-z])+)?)(#)([0-9]+)(?![0-9A-Z_a-z])",
          "name": "string.reference.mdx"
        }
      ]
    },
