...
let json = {json|{
  ...
  "repository": {
    ...
    "access_definition": {
      ...
      "match": "(?i)(not\\s+null\\s+)?(access)\\s+(constant\\s+)?([._\\w\\d]+)\\b",
    ...
    "entry_declaration": {
      "begin": "(?i)\\b(?:(not)?\\s+(overriding)\\s+)?(entry)\\s+([_\\w\\d]+)\\b",
      "beginCaptures": {
        "1": {
          "name": "storage.modifier.ada"
        },
    ...
    "exception_declaration": {
      "begin": "(?i)\\b([_\\w\\d]+(?:\\s*,\\s*[_\\w\\d]+)?)\\s*(:)\\s*(exception)",
      "beginCaptures": {
        "1": {
          "patterns": [
            {
          ...
          "patterns": [
            {
              ...
              "match": "(?i)\\b([_\\w\\d]+)\\s+(in)(\\s+reverse)?\\b"
            },
            {
              "captures": {
                "1": {
              ...
              "match": "(?i)\\b([_\\w\\d]+)(?:\\s*(:)\\s*([._\\w\\d]+))?\\s+(of)(\\s+reverse)?\\b"
            },
            {
              "include": "#expression"
            }
    ...
    "function_body": {
      "begin": "(?i)\\b(overriding\\s+)?(function)\\s+(?:([._\\w\\d]+)\\b|(\".+\"))",
      "beginCaptures": {
        "1": {
          "name": "storage.visibility.ada"
        },
    ...
    "package_body": {
      "begin": "(?i)\\b(package)\\s+(body)\\s+([._\\w\\d]+)\\b",
      "beginCaptures": {
        "1": {
          "name": "keyword.ada"
        },
    ...
    "procedure_body": {
      "begin": "(?i)\\b(overriding\\s+)?(procedure)\\s+([._\\w\\d]+)\\b",
      "beginCaptures": {
        "1": {
          "name": "storage.visibility.ada"
        },
    ...
    "protected_body": {
      "begin": "(?i)\\b(protected)\\s+(body)\\s+([._\\w\\d]+)\\b",
      "beginCaptures": {
        "1": {
          "name": "storage.modifier.ada"
        },
    ...
    "task_body": {
      "begin": "(?i)\\b(task)\\s+(body)\\s+(([._\\w\\d])+)\\b",
      "beginCaptures": {
        "1": {
          "name": "keyword.ada"
        },
    ...
    "task_type_declaration": {
      "begin": "(?i)\\b(task)\\s+(type)\\s+(([._\\w\\d])+)\\b",
      "beginCaptures": {
        "1": {
          "name": "storage.modifier.ada"
        },
