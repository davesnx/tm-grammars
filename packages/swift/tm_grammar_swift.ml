...
let json =
  ...
  "repository": {
    "async-throws": {
      ...
      "match": "\\b(?:((?:throws\\s+|rethrows\\s+)async)|((?:|re)throws)|(async))\\b"
    },
    "attributes": {
      "patterns": [
        {
          ...
          "patterns": [
            ...
            {
              "begin": "\\b((?:introduc|deprecat|obsolet)ed)\\s*(:)\\s*",
              "beginCaptures": {
                "1": {
        ...
        {
          "begin": "(@)(?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>)",
          "beginCaptures": {
            "0": {
              "name": "storage.modifier.attribute.swift"
            },
    ...
    "builtin-global-functions": {
      "patterns": [
        ...
        {
          "match": "\\b(?:s(?:ort|uffix|pli(?:ce|t))|insert|overlaps|d(?:istance|rop(?:First|Last))|join|prefix|extend|withUnsafe(?:Mutable|)Pointers|lazy|advance|re(?:flect|move(?:Range|Last|A(?:tIndex|ll))))(?=\\s*\\()",
          "name": "support.function.swift"
        }
      ]
    },
    ...
    "builtin-types-builtin-class-type": {
      "match": "\\b(Managed((?:|Proto)Buffer)|NonObjectiveCBase|AnyGenerator)\\b",
        ...
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "\\b(canImport)\\s*(\\()([_\\p{L}][_\\p{L}\\p{N}\\p{M}]*)(\\))"
            },
            {
    ...
    "declarations-function": {
      "begin": "\\b(func)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>)|(?:((?<oph>[-!%\\&*+/<-?^|~¡-§©«¬®°±¶»¿×÷‖‗†-‧‰-‾⁁-⁓⁕-⁞←-⏿─-❵➔-⯿⸀-⹿、。〃〈-〰])(\\g<oph>|(?<opc>[̀-ͯ᷀-᷿⃐-⃿︀-️︠-︯\\x{E0100}-\\x{E01EF}]))*)|(\\.(\\g<oph>|\\g<opc>|\\.)+)))\\s*(?=[(<])",
      "beginCaptures": {
        "1": {
          ...
          "patterns": [
            {
              ...
              "match": "(?<=\\G|\\.)(?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>)",
              "name": "entity.name.type.swift"
            },
            {
              "match": "(?<=\\G|\\.)\\$[0-9]+",
    ...
    "declarations-macro": {
      "begin": "\\b(macro)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))\\s*(?=[(<=])",
      "beginCaptures": {
        "1": {
          "name": "storage.type.function.swift"
        },
    ...
    "declarations-operator": {
      "begin": "(?:\\b((?:pre|in|post)fix)\\s+)?\\b(operator)\\s+(((?<oph>[-!%\\&*+/<-?^|~¡-§©«¬®°±¶»¿×÷‖‗†-‧‰-‾⁁-⁓⁕-⁞←-⏿─-❵➔-⯿⸀-⹿、。〃〈-〰])(\\g<oph>|\\.|(?<opc>[̀-ͯ᷀-᷿⃐-⃿︀-️︠-︯\\x{E0100}-\\x{E01EF}]))*+)|(\\.(\\g<oph>|\\g<opc>|\\.)++))\\s*",
      "beginCaptures": {
        "1": {
          "name": "storage.modifier.swift"
        },
    ...
    "declarations-operator-swift3": {
      ...
      "match": "\\G(:)\\s*((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))"
    },
      ...
      "patterns": [
        {
          ...
          "match": "((?<q1>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q1>))\\s+((?<q2>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q2>))(?=\\s*:)"
        },
        {
          "captures": {
            "1": {
          ...
          "match": "(((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>)))(?=\\s*:)"
        },
        {
          "begin": ":\\s*(?!\\s)",
          "end": "(?=[),])",
    ...
    "declarations-precedencegroup": {
      "begin": "\\b(precedencegroup)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))\\s*(?=\\{)",
      "beginCaptures": {
        "1": {
      ...
      "patterns": [
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "\\b((?:high|low)erThan)\\s*:\\s*((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))"
            },
            {
              "captures": {
                "1": {
    ...
    "declarations-protocol": {
      "begin": "\\b(protocol)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))",
      "beginCaptures": {
        "1": {
          "name": "storage.type.$1.swift"
        },
    ...
    "declarations-protocol-associated-type": {
      "begin": "\\b(associatedtype)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))\\s*",
      "beginCaptures": {
        "1": {
          "name": "keyword.other.declaration-specifier.swift"
        },
    ...
    "declarations-type": {
      "patterns": [
        {
          "begin": "\\b(class(?!\\s+(?:func|var|let)\\b)|struct|actor)\\b\\s*((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))",
          "beginCaptures": {
            "1": {
              "name": "storage.type.$1.swift"
            },
    ...
    "declarations-type-enum": {
      "begin": "\\b(enum)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))",
      "beginCaptures": {
        "1": {
          "name": "storage.type.$1.swift"
        },
    ...
    "declarations-type-enum-associated-values": {
      ...
      "patterns": [
        ...
        {
          "begin": "(?:(_)|((?<q1>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*\\k<q1>))\\s+(((?<q2>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*\\k<q2>))\\s*(:)",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.swift"
            },
        ...
        {
          "begin": "(((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*\\k<q>))\\s*(:)",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.swift"
            },
    ...
    "declarations-typealias": {
      "begin": "\\b(typealias)\\s+((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))\\s*",
      "beginCaptures": {
        "1": {
          "name": "keyword.other.declaration-specifier.swift"
        },
    ...
    "declarations-typed-variable-declaration": {
      "begin": "\\b(?:(async)\\s+)?(let|var)\\b\\s+(?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>)\\s*:",
      "beginCaptures": {
        "1": {
          "name": "storage.modifier.async.swift"
        },
    ...
    "expressions-trailing-closure": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "((?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))\\s*(:)(?=\\s*\\{)"
        }
      ]
    },
          ...
          "patterns": [
            {
              ...
              "match": "(?<q>`?)(?!_:)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>):",
              "name": "entity.name.function.compound-name.swift"
            }
          ]
        }
      },
      "match": "((?<q1>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q1>))\\(((((?<q2>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q2>)):)+)\\)"
    },
    ...
    "expressions-without-trailing-closures-or-member-references-macro-expansion": {
      "match": "(#(?<q>`?)[_\\p{L}][_\\p{L}\\p{N}\\p{M}]*(\\k<q>))",
      "name": "support.function.any-method.swift"
    },
    ...
    "keywords": {
      "patterns": [
        ...
        {
          "match": "(?<!\\.)\\b(class|enum|extension|precedencegroup|protocol|struct|actor)\\b(?=\\s*`?[_\\p{L}])",
          "name": "storage.type.$1.swift"
        },
        {
        ...
        {
          "match": "(?<!\\.)\\bunowned\\((?:|un)safe\\)|(?<!\\.)\\b(?:weak|unowned)\\b",
        ...
        {
          "match": "(?:\\B#(?:file|filePath|fileID|line|column|function|dsohandle)|\\b__(?:FILE|LINE|COLUMN|FUNCTION|DSO_HANDLE)__)\\b",
          "name": "support.variable.swift"
        },
        {
          "match": "(?<!\\.)\\bimport\\b",
    ...
    "literals": {
      "patterns": [
        ...
        {
          "match": "\\B#((?:color|image|file)Literal)\\b",
    ...
    "literals-numeric": {
      "patterns": [
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)[0-9][0-9_]*(?=\\.[0-9]|[Ee])(?:\\.[0-9][0-9_]*)?(?:[Ee][-+]?[0-9][0-9_]*)?\\b(?!\\.[0-9])",
          "name": "constant.numeric.float.decimal.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)(0x\\h[_\\h]*)(?:\\.\\h[_\\h]*)?[Pp][-+]?[0-9][0-9_]*\\b(?!\\.[0-9])",
          "name": "constant.numeric.float.hexadecimal.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)(0x\\h[_\\h]*)(?:\\.\\h[_\\h]*)?[Pp][-+]?\\w*\\b(?!\\.[0-9])",
          "name": "invalid.illegal.numeric.float.invalid-exponent.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)(0x\\h[_\\h]*)\\.[0-9][.\\w]*",
        ...
        {
          "match": "(\\B-|\\b)0[box]_[_\\h]*(?:[EPep][-+]?\\w+)?[.\\w]+",
          "name": "invalid.illegal.numeric.leading-underscore.swift"
        },
        {
          "match": "(?<=[]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)[0-9]+\\b"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)0b[01][01_]*\\b(?!\\.[0-9])",
          "name": "constant.numeric.integer.binary.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)0o[0-7][0-7_]*\\b(?!\\.[0-9])",
          "name": "constant.numeric.integer.octal.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)[0-9][0-9_]*\\b(?!\\.[0-9])",
          "name": "constant.numeric.integer.decimal.swift"
        },
        {
          "match": "(\\B-|\\b)(?<![]()\\[_{}\\p{L}\\p{N}\\p{M}]\\.)0x\\h[_\\h]*\\b(?!\\.[0-9])",
    ...
    "literals-regular-expression-literal-group-option-toggle": {
      "match": "\\(\\?(?:\\^(?:[DJPSUWimnswx]|xx|y\\{[gw]})*|(?:[DJPSUWimnswx]|xx|y\\{[gw]})+|(?:[DJPSUWimnswx]|xx|y\\{[gw]})*-(?:[DJPSUWimnswx]|xx|y\\{[gw]})*)\\)",
    ...
    "literals-regular-expression-literal-group-or-conditional": {
      "patterns": [
        ...
        {
          "begin": "(\\()((\\?)(?:([!*:=>|]|<[!*=])|P?<(?:((?!\\d)\\w+)(-))?((?!\\d)\\w+)>|'(?:((?!\\d)\\w+)(-))?((?!\\d)\\w+)'|(?:\\^(?:[DJPSUWimnswx]|xx|y\\{[gw]})*|(?:[DJPSUWimnswx]|xx|y\\{[gw]})+|(?:[DJPSUWimnswx]|xx|y\\{[gw]})*-(?:[DJPSUWimnswx]|xx|y\\{[gw]})*):)|\\*(atomic|pla|positive_lookahead|nla|negative_lookahead|plb|positive_lookbehind|nlb|negative_lookbehind|napla|non_atomic_positive_lookahead|naplb|non_atomic_positive_lookbehind|sr|script_run|asr|atomic_script_run):)?+",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.group.regexp"
            },
          ...
          "patterns": [
            {
              ...
              "match": "\\G(?<=^|[(,:;\\[{\\s])((?!(//|/\\*|\\*/))([-!%\\&*+/<-?^|~¡-§©«¬®°±¶»¿×÷̀-ͯ᷀-᷿‖‗†-‧‰-‾⁁-⁓⁕-⁞⃐-⃿←-⏿─-❵➔-⯿⸀-⹿、。〃〈-〰︀-️︠-︯\\x{E0100}-\\x{E01EF}]))++(?![]),:;}\\s]|\\z)"
            },
            {
              "captures": {
                "0": {
            ...
            },
            {
              ...
              "match": "\\G((?!(//|/\\*|\\*/))([-!%\\&*+/<-?^|~¡-§©«¬®°±¶»¿×÷̀-ͯ᷀-᷿‖‗†-‧‰-‾⁁-⁓⁕-⁞⃐-⃿←-⏿─-❵➔-⯿⸀-⹿、。〃〈-〰︀-️︠-︯\\x{E0100}-\\x{E01EF}]))++"
            },
            {
              "captures": {
                "0": {
