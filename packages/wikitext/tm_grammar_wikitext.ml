        ...
        "magic-words": {
          ...
          "repository": {
            ...
            "variables": {
              "patterns": [
                {
                  "match": "(?i)(\\{\\{)(CURRENTYEAR|CURRENTMONTH1??|CURRENTMONTHNAME|CURRENTMONTHNAMEGEN|CURRENTMONTHABBREV|CURRENTDAY2??|CURRENTDOW|CURRENTDAYNAME|CURRENTTIME|CURRENTHOUR|CURRENTWEEK|CURRENTTIMESTAMP|LOCALYEAR|LOCALMONTH1??|LOCALMONTHNAME|LOCALMONTHNAMEGEN|LOCALMONTHABBREV|LOCALDAY2??|LOCALDOW|LOCALDAYNAME|LOCALTIME|LOCALHOUR|LOCALWEEK|LOCALTIMESTAMP)(}})",
                  "name": "constant.language.variables.time.wikitext"
                },
                {
                  "match": "(?i)(\\{\\{)(SITENAME|SERVER|SERVERNAME|DIRMARK|DIRECTIONMARK|SCRIPTPATH|STYLEPATH|CURRENTVERSION|CONTENTLANGUAGE|CONTENTLANG|PAGEID|PAGELANGUAGE|CASCADINGSOURCES|REVISIONID|REVISIONDAY2??|REVISIONMONTH1??|REVISIONYEAR|REVISIONTIMESTAMP|REVISIONUSER|REVISIONSIZE)(}})",
          ...
          "repository": {
            ...
            "syntax-highlight": {
              ...
              "repository": {
                ...
                "hl-dockerfile": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)docker(?:|file)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-elixir": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)e(?:lixir|xs??)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-fsharp": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)f(?:sharp|#)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-go": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)go(?:|lang)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-js": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)j(?:avascript|s)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-latex": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)(?:|la)tex\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-markdown": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)m(?:arkdown|d)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-perl": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)p(?:erl|le)\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-php": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)php[345]??\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
                ...
                "hl-r": {
                  "begin": "(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?\\s+lang=([\"']?)(?:splus|[rs])\\4(?:\\s+[^>]+)?)\\s*(>)",
                  "beginCaptures": {
                    "0": {
                      "name": "meta.tag.metadata.start.wikitext"
                    },
