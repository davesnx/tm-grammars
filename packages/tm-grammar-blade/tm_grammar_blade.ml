  ...
  "repository": {
    ...
    "blade": {
      "patterns": [
        ...
        {
          "match": "(?<![0-9@-Z_a-z])@(?:append|break|continue|csrf|default|each|else|overwrite|parent|sectionMissing|show|stack|stop|livewireStyles|livewireScripts)\\b",
          "name": "keyword.blade"
        },
        {
          "match": "(?<![0-9@-Z_a-z])@(end)?(?i:auth|can|canany|cannot|component|empty|error|for|foreach|forelse|guest|if|isset|lang|prepend|push|section|slot|switch|unless|verbatim|while|task|story|finished|production|env|once|pushOnce|pushIf|prependOnce|session)\\b",
          "name": "keyword.blade"
        },
        {
          "begin": "(?<![0-9@-Z_a-z])@(?i:php|setup)\\b",
          "beginCaptures": {
            "0": {
              "name": "punctuation.section.embedded.begin.php"
            }
          ...
          "contentName": "source.php",
          "end": "(?<![0-9@-Z_a-z])(?=@(?i:end(?:php|setup))\\b)",
          "endCaptures": {
            "0": {
              "name": "punctuation.section.embedded.end.php"
            }
        ...
        {
          "begin": "(?<![0-9@-Z_a-z])(@(?i:end(?:php|setup))[\\t ]*)(\\()",
          "beginCaptures": {
            "1": {
              "name": "punctuation.section.embedded.end.php"
            },
        ...
        {
          "match": "(?<![0-9@-Z_a-z])@(?:(?i)endphp|endsetup)\\b",
          "name": "punctuation.section.embedded.end.php"
        },
        {
          "begin": "(?<![0-9@-Z_a-z])(@\\w+(?:::w+)?[\\t ]*)(\\()",
    ...
    "constants": {
      "patterns": [
        ...
        {
          "match": "(?i)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*",
    ...
    "function-call": {
      "patterns": [
        {
          "begin": "(?i)(\\\\?\\b[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*(?:\\\\[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)+)\\s*(\\()",
          "beginCaptures": {
            "1": {
              "patterns": [
                {
        ...
        {
          "begin": "(?i)(\\\\)?\\b([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(\\()",
          "beginCaptures": {
            "1": {
              "patterns": [
                {
    ...
    "function-parameters": {
      "patterns": [
        ...
        {
          "begin": "(?i)(array)\\s+((&)?\\s*(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(=)\\s*(array)\\s*(\\()",
          "beginCaptures": {
            "1": {
        ...
        },
        {
          ...
          "match": "(?i)(array|callable)\\s+((&)?\\s*(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)(?:\\s*(=)\\s*(?:(null)|(\\[)((?>[^]\\[]+|\\[\\g<8>])*)(])|(\\S*?\\(\\)|\\S*?)))?\\s*(?=[),]|/[*/]|#|$)",
          "name": "meta.function.parameter.array.php"
        },
        {
          "begin": "(?i)(\\\\?(?:[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*\\\\)*)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s+((&)?\\s*(\\.\\.\\.)?(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)",
          "beginCaptures": {
            "1": {
        ...
        },
        {
          ...
          "match": "(?i)((&)?\\s*(\\.\\.\\.)?(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(?=[),]|/[*/]|#|$)",
          "name": "meta.function.parameter.no-default.php"
        },
        {
          "begin": "(?i)((&)?\\s*(\\.\\.\\.)?(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(=)\\s*(?:(\\[)((?>[^]\\[]+|\\[\\g<6>])*)(]))?",
          "beginCaptures": {
            "1": {
              "name": "variable.other.php"
            },
    ...
    "heredoc": {
      "patterns": [
        {
          "begin": "(?i)(?=<<<\\s*(\"?)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)(\\1)\\s*$)",
          "end": "(?!\\G)",
      ...
      "patterns": [
        ...
        },
        {
          ...
          "patterns": [
            ...
            {
              "begin": "(?i)(?<=^|\\s)(#)\\s(?=[-\\t !,.0-9?_a-z\\x7F-ÿ[^\\x00-\\x7F]]*$)",
              "beginCaptures": {
                "1": {
                  "name": "punctuation.definition.comment.php"
                }
        ...
        {
          "begin": "(?i)(<<<)\\s*(\"?)([_a-z\\x7F-ÿ]+[0-9_a-z\\x7F-ÿ]*)(\\2)(\\s*)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.php"
            },
    ...
    "instantiation": {
      ...
      "end": "(?i)(?=[^0-9\\\\_a-z\\x7F-ÿ])",
      "patterns": [
        {
          "match": "(?i)(parent|static|self)(?![0-9_a-z\\x7F-ÿ])",
          "name": "storage.type.php"
        },
        {
          "include": "#class-name"
    ...
    "invoke-call": {
      ...
      "match": "(?i)(\\$+)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)(?=\\s*\\()",
    ...
    "language": {
      "patterns": [
        ...
        {
          "begin": "(?i)^\\s*(interface)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(extends)?\\s*",
          "beginCaptures": {
            "1": {
          ...
          "end": "(?i)((?:[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*\\s*,\\s*)*)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)?\\s*(?:(?=\\{)|$)",
          "endCaptures": {
            "1": {
              "patterns": [
                {
        ...
        {
          "begin": "(?i)^\\s*(trait)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)",
          "beginCaptures": {
            "1": {
        ...
        },
        {
          ...
          "match": "(?i)(?:^|(?<=<\\?php))\\s*(namespace)\\s+([0-9\\\\_a-z\\x7F-ÿ]+)(?=\\s*;)",
            ...
            },
            {
              ...
              "patterns": [
                ...
                },
                {
                  ...
                  "match": "(?i)\\b(as)\\s+(final|abstract|public|private|protected|static)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\b"
                },
                {
                  "captures": {
                    "1": {
                  ...
                  "match": "(?i)\\b(as)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\b"
                },
                {
                  "captures": {
                    "1": {
                  ...
                  "match": "(?i)\\b(insteadof)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)"
                },
                {
                  "match": ";",
        ...
        {
          "begin": "(?i)^\\s*(?:(abstract|final)\\s+)?(class)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)",
          "beginCaptures": {
            "1": {
          ...
          "patterns": [
              ...
              "patterns": [
                {
                  ...
                  "end": "(?i)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)?(?=[^0-9\\\\_a-z\\x7F-ÿ])",
                  "endCaptures": {
                    "1": {
                      "name": "entity.other.inherited-class.php"
                    }
            ...
            },
            {
              ...
              "patterns": [
                ...
                {
                  "begin": "(?i)(?=[0-9\\\\_a-z\\x7F-ÿ]+)",
                  "contentName": "meta.other.inherited-class.php",
                  "end": "(?i)\\s*(?:,|(?=[^0-9\\\\_a-z\\x7F-ÿ\\s]))\\s*",
                  "patterns": [
                    {
                      "begin": "(?i)(?=\\\\?[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*\\\\)",
                      "end": "(?i)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)?(?=[^0-9\\\\_a-z\\x7F-ÿ])",
        ...
        },
        {
          ...
          "match": "\\s*\\b(break|case|continue|declare|default|die|do|else(if)?|end(declare|for(each)?|if|switch|while)|exit|for(each)?|if|return|switch|use|while|yield)\\b"
        },
        {
        ...
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(?i)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)((?:\\s*\\|\\s*[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)*)\\s*((\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)"
            }
          ]
        },
        {
        ...
        {
          "begin": "((?:(?:final|abstract|public|private|protected|static)\\s+)*)(function)\\s+(?i:(__(?:call|construct|debugInfo|destruct|get|set|isset|unset|tostring|clone|set_state|sleep|wakeup|autoload|invoke|callStatic))|([A-Z_a-z\\x7F-ÿ][0-9A-Z_a-z\\x7F-ÿ]*))\\s*(\\()",
          "beginCaptures": {
            "1": {
              "patterns": [
                {
          ...
          "contentName": "meta.function.parameters.php",
          "end": "(\\))(?:\\s*(:)\\s*([A-Z_a-z\\x7F-ÿ][0-9A-Z_a-z\\x7F-ÿ]*))?",
          "endCaptures": {
            "1": {
              "name": "punctuation.definition.parameters.end.bracket.round.php"
            },
        ...
        },
        {
          ...
          "match": "(?i)(goto)\\s+([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)"
        },
        {
          "captures": {
            "1": {
    ...
    "namespace": {
      "begin": "(?i)(?:(namespace)|[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)?(\\\\)(?=.*?[^0-9\\\\_a-z\\x7F-ÿ])",
      "beginCaptures": {
        "1": {
      ...
      "end": "(?i)(?=[0-9_a-z\\x7F-ÿ]*[^0-9\\\\_a-z\\x7F-ÿ])",
      "name": "support.other.namespace.php",
      "patterns": [
        {
          "match": "\\\\",
    ...
    "nowdoc_interior": {
      "patterns": [
        ...
        {
          "begin": "(?i)(<<<)\\s*'([_a-z\\x7F-ÿ]+[0-9_a-z\\x7F-ÿ]*)'(\\s*)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.php"
            },
    ...
    "object": {
      "patterns": [
        ...
        {
          "begin": "(?i)(->)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(\\()",
          "beginCaptures": {
            "1": {
              "name": "keyword.operator.class.php"
            },
    ...
    "parameter-default-types": {
      "patterns": [
        ...
        {
          "begin": "(?i)(?=[0-9\\\\_a-z\\x7F-ÿ]+(::)([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)?)",
    ...
    "php_doc": {
      "patterns": [
        ...
        {
          "begin": "(@(?:global|param|property(-(read|write))?|return|throws|var))\\s+(?=[(A-Z\\\\_a-z\\x7F-ÿ])",
          "beginCaptures": {
            "1": {
              "name": "keyword.other.phpdoc.php"
            }
    ...
    "php_doc_types": {
      "captures": {
        "0": {
          "patterns": [
            {
              "match": "\\b(string|integer|int|boolean|bool|float|double|object|mixed|array|resource|void|null|callback|false|true|self)\\b",
      ...
      "match": "(?i)[\\\\_a-z\\x7F-ÿ][0-9\\\\_a-z\\x7F-ÿ]*(\\|[\\\\_a-z\\x7F-ÿ][0-9\\\\_a-z\\x7F-ÿ]*)*"
    },
    ...
    "php_doc_types_array_single": {
      ...
      "match": "(?i)([\\\\_a-z\\x7F-ÿ][0-9\\\\_a-z\\x7F-ÿ]*)(\\[])"
    },
    "regex-double-quoted": {
      "begin": "\"/(?=(\\\\.|[^\"/])++/[ADSUXeimsux]*\")",
      "beginCaptures": {
      ...
      "patterns": [
        {
          ...
          "match": "(?i)\\b([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)(?=\\s*::)"
        },
        {
          "begin": "(?i)(::)\\s*([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)\\s*(\\()",
          "beginCaptures": {
        ...
        },
        {
          ...
          "match": "(?i)(::)\\s*(?:((\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)|([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*))?"
        }
      ]
    },
    ...
    "support": {
      "patterns": [
        ...
        {
          "match": "(?i)\\b((restore|set)_(e(?:rror|xception)_handler)|trigger_error|debug_(print_)?backtrace|user_error|error_(log|reporting|get_last))\\b",
        ...
        {
          "match": "(?i)\\bgmp_(scan[01]|strval|sign|sub|setbit|sqrt(rem)?|hamdist|neg|nextprime|com|clrbit|cmp|testbit|intval|init|invert|import|or|div(exact)?|div_(qr??|r)|jacobi|popcount|pow(m)?|perfect_square|prob_prime|export|fact|legendre|and|add|abs|root(rem)?|random(_(bits|range))?|gcd(ext)?|xor|mod|mul)\\b",
        ...
        {
          "match": "(?i)\\b(iconv(_(str(pos|len|rpos)|substr|([gs]et)_encoding|mime_(decode(_headers)?|encode)))?|ob_iconv_handler)\\b",
        ...
        {
          "match": "(?i)\\b((a)?(cos|sin|tan)(h)?|sqrt|srand|hypot|hexdec|ceil|is_(nan|(in)?finite)|octdec|dec(hex|oct|bin)|deg2rad|pi|pow|exp(m1)?|floor|fmod|lcg_value|log(1([0p]))?|atan2|abs|round|rand|rad2deg|getrandmax|mt_(srand|rand|getrandmax)|max|min|bindec|base_convert)\\b",
        ...
        {
          "match": "(?i)\\bpcntl_(strerror|signal(_dispatch)?|sig(timedwait|procmask|waitinfo)|setpriority|errno|exec|fork|w(stopsig|termsig|if((?:stopp|signal|exit)ed))|wait(pid)?|alarm|getpriority|get_last_error)\\b",
        ...
        {
          "match": "(?i)\\b(virtual|getallheaders|apache_(([gs]et)env|note|child_terminate|lookup_uri|response_headers|reset_timeout|request_headers|get_(version|modules)))\\b",
        ...
        {
          "match": "(?i)\\b(tidy_(([gs]et)opt|set_encoding|save_config|config_count|clean_repair|is_(x(?:html|ml))|diagnose|(access|error|warning)_count|load_config|reset_config|(parse|repair)_(string|file)|get_(status|html(_ver)?|head|config|output|opt_doc|root|release|body))|ob_tidyhandler)\\b",
        ...
        {
          "match": "(?i)\\b(utf8_((?:de|en)code)|xml_(set_((notation|(end|start)_namespace|unparsed_entity)_decl_handler|(character_data|default|element|external_entity_ref|processing_instruction)_handler|object)|parse(_into_struct)?|parser_(([gs]et)_option|create(_ns)?|free)|error_string|get_(current_((column|line)_number|byte_index)|error_code)))\\b",
          "name": "support.function.xml.php"
        },
        {
          "match": "(?i)\\bxmlrpc_(server_(call_method|create|destroy|add_introspection_data|register_(introspection_callback|method))|is_fault|decode(_request)?|parse_method_descriptions|encode(_request)?|([gs]et)_type)\\b",
      ...
      "patterns": [
        {
          ...
          "match": "(?i)(\\$+)[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*\\b",
          "name": "variable.other.php"
        }
      ]
    },
    ...
    "variable-name": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "(?i)((\\$)(?<name>[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*))(?:(->)(\\g<name>)|(\\[)(?:(\\d+)|((\\$)\\g<name>)|([_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*))(]))?"
        },
        {
          "captures": {
            "1": {
          ...
          "match": "(?i)((\\$\\{)(?<name>[_a-z\\x7F-ÿ][0-9_a-z\\x7F-ÿ]*)(}))"
        }
      ]
    },
    "variables": {
