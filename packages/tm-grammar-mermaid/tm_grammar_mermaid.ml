      ...
      "patterns": [
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(?i)\\s*([-\\w]+)\\s*(\\{)?\\s*(group)?(})?\\s*(:)\\s*([BLRT])\\s+(<?-->?)\\s+([BLRT])\\s*(:)\\s*([-\\w]+)\\s*(\\{)?\\s*(group)?(})?"
            },
            {
              "captures": {
                "1": {
        ...
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(?i)\\s*([-\\w]+)\\s*((?:\\|o|\\|\\||}o|}\\||one or (?:zero|more|many)|zero or (?:one|more|many)|many\\([01]\\)|only one|0\\+|1\\+?)(?:..|--)(?:o\\||\\|\\||o\\{|\\|\\{|one or (?:zero|more|many)|zero or (?:one|more|many)|many\\([01]\\)|only one|0\\+|1\\+?))\\s*([-\\w]+)\\s*(:)\\s*(\"[\\w\\s]*\"|[-\\w]+)"
            }
          ]
        },
        {
        ...
        {
          "begin": "^\\s*(graph|flowchart)\\s+([ 0-9\\p{L}]+)?",
          "beginCaptures": {
            "1": {
              "name": "keyword.control.mermaid"
            },
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(?i)\\s*([<ox]?(?:-{2,5}|={2,5}|-\\.{1,3}|-\\.))((?:(?!--|==)[!-'*-/:<-?\\[-^`\\w\\s])*)((?:-{2,5}|={2,5}|\\.{1,3}-|\\.-)[>ox]?)"
            },
            {
              "captures": {
                "1": {
        ...
        },
        {
          ...
          "patterns": [
            ...
            },
            {
              ...
              "match": "(?i)^\\s*(\\w+)\\s*(-)\\s*((?:contain|copie|derive|satisfie|verifie|refine|trace)s)\\s*(->)\\s*(\\w+)\\s*$"
            },
            {
              "captures": {
                "1": {
