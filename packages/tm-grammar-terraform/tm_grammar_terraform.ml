...
let json = {json|{
  ...
  "repository": {
    "attribute_access": {
      ...
      "endCaptures": {
        "0": {
          "patterns": [
            {
              "match": "(?!null|false|true)\\p{alpha}[-\\w]*",
    ...
    "attribute_definition": {
      ...
      "match": "(\\()?\\b((?!(?:null|false|true)\\b)\\p{alpha}[-_[:alnum:]]*)(\\))?\\s*(=(?![=>]))\\s*",
      ...
      "beginCaptures": {
        "1": {
          "patterns": [
            ...
            {
              "match": "\\b(?!null|false|true)\\p{alpha}[-_[:alnum:]]*\\b",
    ...
    "objects": {
      ...
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b((?!null|false|true)\\p{alpha}[-_[:alnum:]]*)\\s*(=>?)\\s*"
        },
        {
          "captures": {
            "0": {
