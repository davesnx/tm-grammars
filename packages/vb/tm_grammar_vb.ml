...
let json =
  ...
  "patterns": [
    ...
    },
    {
      ...
      "match": "^\\s*((?i:function|sub))\\s*([A-Z_a-z]\\w*)\\s*(\\()([^)]*)(\\)).*\\n?",
    ...
    },
    {
      ...
      "match": "(?i:(dim)\\s*\\b([7A-Z_a-z][0-9A-Z_a-z]*?)\\b\\s*(,?))",
    ...
    {
      "match": "(?i:(?<=as )\\b([7A-Z_a-z][0-9A-Z_a-z]*?)\\b)",
    ...
    },
    {
      ...
      "match": "(?i:\\b([7A-Z_a-z][0-9A-Z_a-z]*?)\\b(?=\\(\\)?))",
      "name": "support.function.asp"
    },
    {
      "match": "(?i:((?<=([-\\&(+,/<=>\\\\]))\\s*\\b([7A-Z_a-z][0-9A-Z_a-z]*?)\\b(?!([(.]))|\\b([7A-Z_a-z][0-9A-Z_a-z]*?)\\b(?=\\s*([-\\&()+/<=>\\\\]))))",
      "name": "variable.other.asp"
    },
    {
