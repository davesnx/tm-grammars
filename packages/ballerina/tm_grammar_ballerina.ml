...
let json =
  ...
  "repository": {
    ...
    "regex-unicode-properties-general-category": {
      "patterns": [
        {
          "match": "(Lu|Ll|Lt|Lm|Lo?|Mn|Mc|Me?|Nd|Nl|No?|Pc|Pd|Ps|Pe|Pi|Pf|Po?|Sm|Sc|Sk|So?|Zs|Zl|Zp?|Cf|Cc|Cn|Co?)",
          ...
          "patterns": [
            {
              ...
              "match": "(?:.|(\\\\(?:[0-7]{3}|x\\h{2}|u\\h{4}))|(\\\\[^Ppu]))-(?:[^]\\\\]|(\\\\(?:[0-7]{3}|x\\h{2}|u\\h{4}))|(\\\\[^Ppu]))",
      ...
      "patterns": [
        {
          ...
          "match": "\\b(self)\\b\\s*(.)\\s*([$_[:alpha:]][$_[:alnum:]]*)\\s*(?=\\()"
        },
        {
    ...
    "source": {
      "patterns": [
        {
          "begin": "\\b(source)\\b\\s+([$_[:alpha:]][$_[:alnum:]]*)",
          "beginCaptures": {
            "1": {
              "name": "keyword.other.ballerina"
            },
    ...
    "typeDefinition": {
      "patterns": [
        {
          "begin": "\\b(type)\\b\\s+([$_[:alpha:]][$_[:alnum:]]*)",
          "beginCaptures": {
            "1": {
              "name": "keyword.other.ballerina"
            },
