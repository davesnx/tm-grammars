...
let json = {json|{
  ...
  "repository": {
    ...
    "binary-integer": {
      "patterns": [
        {
          "match": "\\b(0[Bb])[01_]+(Lu|LU|uL|UL|[LUu])?\\b",
      ...
      "patterns": [
        {
          ...
          "match": "\\b(class)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        },
        {
          "include": "#protection-attribute"
        },
    ...
    "decimal-float": {
      "patterns": [
        {
          "match": "\\b((\\.[0-9])|(0\\.)|(([1-9]|(0[1-9_]))[0-9_]*\\.))[0-9_]*((e-|E-|e\\+|E\\+|[Ee])[0-9][0-9_]*)?[FLf]?i?\\b",
    ...
    "decimal-integer": {
      "patterns": [
        {
          "match": "\\b(0(?=[^BXbx\\d]))|([1-9][0-9_]*)(Lu|LU|uL|UL|[LUu])?\\b",
    ...
    "escape-sequence": {
      "patterns": [
        ...
        {
          "match": "(\\\\(?:x[_\\h]{2}|u[_\\h]{4}|U[_\\h]{8}|[0-7]{1,3}))",
    ...
    "function-prelude": {
      "patterns": [
        {
          "match": "(?!type(?:of|id))((\\.\\s*)?[_\\w][_\\d\\w]*)(\\s*\\.\\s*[_\\w][_\\d\\w]*)*\\s*(?=\\()",
    ...
    "hexadecimal-float": {
      "patterns": [
        {
          "match": "\\b0[Xx][_\\h]*(\\.[_\\h]*)?(p-|P-|p\\+|P\\+|[Pp])[0-9][0-9_]*[FLf]?i?\\b",
    ...
    "hexadecimal-integer": {
      "patterns": [
        {
          "match": "\\b(0[Xx])(\\h[_\\h]*)(Lu|LU|uL|UL|[LUu])?\\b",
    ...
    "import-identifier": {
      "patterns": [
        {
          "match": "([A-Z_a-z][_\\d\\w]*)(\\s*\\.\\s*[A-Z_a-z][_\\d\\w]*)*",
      ...
      "patterns": [
        {
          ...
          "match": "\\b(interface)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        }
      ]
    },
      ...
      "patterns": [
        {
          ...
          "match": "\\b(mixin\\s*template)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        }
      ]
    },
    "module": {
    ...
    "special-keyword": {
      "patterns": [
        {
          "match": "\\b(__(?:FILE|FILE_FULL_PATH|MODULE|LINE|FUNCTION|PRETTY_FUNCTION)__)\\b",
    ...
    "special-tokens": {
      "patterns": [
        {
          "match": "\\b(__(?:DATE|TIME|TIMESTAMP|VENDOR|VERSION)__)\\b",
      ...
      "patterns": [
        {
          ...
          "match": "\\b(struct)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        }
      ]
    },
    "switch-statement": {
      ...
      "patterns": [
        {
          ...
          "match": "\\b(template)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        }
      ]
    },
    "throw-statement": {
      ...
      "patterns": [
        {
          ...
          "match": "\\b(union)(?:\\s+([A-Z_a-z][_\\w\\d]*))?\\b"
        }
      ]
    },
