...
let json =
  ...
  "patterns": [
    ...
    },
    {
      ...
      "match": "\\b(Auth(?:Authoritative|GroupFile|UserFile|BasicProvider|BasicFake|BasicAuthoritative|BasicUseDigestAlgorithm))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Anonymous(?:|_Authoritative|_LogEmail|_MustGiveEmail|_NoUserID|_VerifyEmail))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(AuthDBM(?:Authoritative|GroupFile|Type|UserFile))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(AuthDigest(?:Algorithm|Domain|File|GroupFile|NcCheck|NonceFormat|NonceLifetime|Qop|ShmemSize|Provider))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(AuthLDAP(?:Authoritative|BindDN|BindPassword|CharsetConfig|CompareDNOnServer|DereferenceAliases|Enabled|FrontPageHack|GroupAttribute|GroupAttributeIsDN|RemoteUserIsDN|Url))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(Balancer(?:Member|Growth|Persist|Inherit))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Cache(?:DefaultExpire|Disable|Enable|ForceCompletion|IgnoreCacheControl|IgnoreHeaders|IgnoreNoLastMod|LastModifiedFactor|MaxExpire))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Meta(?:Dir|Files|Suffix))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(ScriptLog(?:|Buffer|Length))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Script(?:Log|LogBuffer|LogLength|Sock))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Charset(?:Default|Options|SourceEnc))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Dav(?:|DepthInfinity|MinTimeout|LockDB))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Deflate(?:BufferSize|CompressionLevel|FilterNote|MemLevel|WindowSize))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(Cache(?:DirLength|DirLevels|ExpiryCheck|GcClean|GcDaily|GcInterval|GcMemUsage|GcUnused|MaxFileSize|MinFileSize|Root|Size|TimeMargin))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(Expires(?:Active|ByType|Default))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(ExtFilter(?:Define|Options))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(Imap(?:Base|Default|Menu))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(ISAPI(?:AppendLogToErrors|AppendLogToQuery|CacheFile|FakeAsync|LogNotSupported|ReadAheadBuffer))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(LDAP(?:CacheEntries|CacheTTL|ConnectionTimeout|OpCacheEntries|OpCacheTTL|SharedCacheFile|SharedCacheSize|TrustedCA|TrustedCAType))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(MCache(?:MaxObjectCount|MaxObjectSize|MaxStreamingBuffer|MinObjectSize|RemovalAlgorithm|Size))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(Rewrite(?:Base|Cond|Engine|Lock|Log|LogLevel|Map|Options|Rule))\\b"
    },
    {
      "captures": {
        "1": {
    ...
    },
    {
      ...
      "match": "\\b(SSL(?:CACertificateFile|CACertificatePath|CARevocationFile|CARevocationPath|CertificateChainFile|CertificateFile|CertificateKeyFile|CipherSuite|Engine|Mutex|Options|PassPhraseDialog|Protocol|ProxyCACertificateFile|ProxyCACertificatePath|ProxyCARevocationFile|ProxyCARevocationPath|ProxyCipherSuite|ProxyEngine|ProxyMachineCertificateFile|ProxyMachineCertificatePath|ProxyProtocol|ProxyVerify|ProxyVerifyDepth|RandomSeed|Require|RequireSSL|SessionCache|SessionCacheTimeout|UserName|VerifyClient|VerifyDepth|InsecureRenegotiation|OpenSSLConfCmd))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Substitute(?:|InheritBefore|MaxLineLength))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Cookie(?:Domain|Expires|Name|Style|Tracking))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(Virtual(?:DocumentRoot|DocumentRootIP|ScriptAlias|ScriptAliasIP))\\b"
    },
    {
      "captures": {
        "1": {
      ...
      "match": "\\b(php_(?:value|flag|admin_value|admin_flag))\\b(\\s+(.+?)(\\s+(\".+?\"|.+?))?)?\\s"
    },
    {
      "captures": {
        "1": {
