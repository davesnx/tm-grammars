...
let json = {json|{
  ...
  "repository": {
    "architecture_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:architecture))\\s+(([A-z][0-9A-z]*)|(.+))(?=\\s)\\s+((?i:of))\\s+(([A-Za-z][0-9A-Z_a-z]*)|(.+?))(?=\\s*(?i:is))\\b",
          "beginCaptures": {
            "1": {
    ...
    "block_pattern": {
      "patterns": [
        {
          "begin": "^\\s*(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?(\\s*(?i:block))",
          "beginCaptures": {
            "2": {
    ...
    "case_pattern": {
      "patterns": [
        {
          "begin": "^\\s*((([A-Za-z][0-9A-Z_a-z]*)|(.+?))\\s*:\\s*)?\\b((?i:case))\\b",
          "beginCaptures": {
            "3": {
    ...
    "component_instantiation_pattern": {
      "patterns": [
        {
          "begin": "^\\s*([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*([A-Za-z][0-9A-Z_a-z]*)\\b(?=\\s*($|generic|port))",
          "beginCaptures": {
            "1": {
    ...
    "component_pattern": {
      "patterns": [
        {
          "begin": "^\\s*\\b((?i:component))\\s+(([A-Z_a-z][0-9A-Z_a-z]*)\\s*|(.+?))(?=\\b(?i:is|port)\\b|$|--)(\\b((?i:is\\b)))?",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "entity_instantiation_pattern": {
      "patterns": [
        {
          "begin": "^\\s*([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*(((?i:use))\\s+)?((?i:entity))\\s+((([A-Za-z][0-9A-Z_a-z]*)|(.+?))(\\.))?(([A-Za-z][0-9A-Z_a-z]*)|(.+?))(?=\\s*(\\(|$|(?i:port|generic)))(\\s*(\\()\\s*(([A-Za-z][0-9A-Z_a-z]*)|(.+?))(?=\\s*\\))\\s*(\\)))?",
          "beginCaptures": {
            "1": {
    ...
    "entity_pattern": {
      "patterns": [
        {
          "begin": "^\\s*((?i:entity\\b))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(.+?))(?=\\s)",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "for_pattern": {
      "patterns": [
        {
          "begin": "^\\s*(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?(?!(?i:wait\\s*))\\b((?i:for))\\b(?!\\s*(?i:all))",
          "beginCaptures": {
            "2": {
    ...
    "function_definition_pattern": {
      "patterns": [
        {
          "begin": "^\\s*((?i:impure)?\\s*(?i:function))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(\"\\S+\")|(\\\\.+\\\\)|(.+?))(?=\\s*(\\(|(?i:\\breturn\\b)))",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "if_pattern": {
      "patterns": [
        {
          "begin": "(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?\\b((?i:if))\\b",
          "beginCaptures": {
            "2": {
    ...
    "loop_pattern": {
      "patterns": [
        {
          "begin": "^\\s*(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?\\b((?i:loop))\\b",
          "beginCaptures": {
            "2": {
    ...
    "package_body_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:package))\\s+((?i:body))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(.+?))\\s+((?i:is))\\b",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "package_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:package))\\s+(?!(?i:body))(([A-Za-z][A-Z_a-z\\d]*)|(.+?))\\s+((?i:is))\\b",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "procedure_definition_pattern": {
      "patterns": [
        {
          "begin": "^\\s*((?i:procedure))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(\"\\S+\")|(.+?))(?=\\s*(\\(|(?i:is)))",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "procedure_prototype_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:procedure))\\s+(([A-Za-z][0-9A-Z_a-z]*)|(.+?))(?=\\s*([(;]))",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "process_pattern": {
      "patterns": [
        {
          "begin": "^\\s*(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?((?:postponed\\s+)?(?i:process\\b))",
          "beginCaptures": {
            "2": {
    ...
    "protected_body_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:type))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(.+?))\\s+\\b((?i:is\\s+protected\\s+body))\\s+",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "protected_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:type))\\s+(([A-Za-z][A-Z_a-z\\d]*)|(.+?))\\s+\\b((?i:is\\s+protected))\\s+(?!(?i:body))",
          "beginCaptures": {
            "1": {
      ...
      "patterns": [
        {
          ...
          "end": "\\b((?i:end))\\s+((?i:record))(\\s+(([A-Za-z][A-Z_a-z\\d]*)|(.*?)))?(?=\\s*;)",
          "endCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "subtype_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:subtype))\\s+(([A-Za-z][0-9A-Z_a-z]*)|(.+?))\\s+((?i:is))\\b",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "support_constants": {
      "patterns": [
        {
          "match": "\\b(?i:math_(?:1_over_e|1_over_pi|1_over_sqrt_2|2_pi|3_pi_over_2|deg_to_rad|e|log10_of_e|log2_of_e|log_of_10|log_of_2|pi|pi_over_2|pi_over_3|pi_over_4|rad_to_deg|sqrt_2|sqrt_pi))\\b",
    ...
    "support_functions": {
      "patterns": [
        ...
        {
          "match": "\\b(?i:arccos(h?)|arcsin(h?)|arctanh??|cbrt|ceil|cosh??|exp|floor|log10|log2?|realmax|realmin|round|sign|sinh??|sqrt|tanh??|trunc)\\b",
    ...
    "type_pattern": {
      "patterns": [
        {
          "begin": "\\b((?i:type))\\s+(([A-Za-z][0-9A-Z_a-z]*)|(.+?))((?=\\s*;)|(\\s+((?i:is))))\\b",
          "beginCaptures": {
            "1": {
              "name": "keyword.language.vhdl"
            },
    ...
    "while_pattern": {
      "patterns": [
        {
          "begin": "^\\s*(([A-Za-z][0-9A-Z_a-z]*)\\s*(:)\\s*)?\\b((?i:while))\\b",
          "beginCaptures": {
            "2": {
              "name": ""
            },
