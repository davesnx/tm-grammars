...
let json = {json|{
  ...
  "patterns": [
    ...
    {
      "match": "\\b(?i:(CMAKE_)?(C(?:XX_FLAGS|MAKE_CXX_FLAGS_DEBUG|MAKE_CXX_FLAGS_MINSIZEREL|MAKE_CXX_FLAGS_RELEASE|MAKE_CXX_FLAGS_RELWITHDEBINFO)))\\b",
      "name": "variable.source.cmake"
    }
  ],
  "repository": {
