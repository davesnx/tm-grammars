...
let json =
  ...
  "repository": {
    ...
    "constant-time": {
      "match": "\\b((?:second|minute|hour|day|week|year)s)\\b",
    ...
    "control-pragma": {
      ...
      "match": "\\b(pragma)(?:\\s+([A-Z_a-z]\\w+)\\s+(\\S+))?\\b"
    },
    "control-unchecked": {
      "match": "\\b(unchecked)\\b",
      ...
      "patterns": [
        {
          ...
          "match": "\\b(using)\\b\\s+\\b([A-Z_a-z\\d]+)\\b\\s+\\b(for)\\b\\s+\\b([A-Z_a-z\\d]+)"
        },
        {
          "match": "\\b(using)\\b",
          "name": "keyword.control.using"
    ...
    "declaration-contract": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b(contract)(\\s+([A-Z_a-z]\\w*))?\\b"
        }
      ]
    },
    "declaration-enum": {
    ...
    "declaration-function": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b(function)\\s+([A-Z_a-z]\\w*)\\b"
        }
      ]
    },
    ...
    "declaration-interface": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b(interface)(\\s+([A-Z_a-z]\\w*))?\\b"
        }
      ]
    },
    "declaration-library": {
    ...
    "declaration-modifier": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "\\b(modifier)(\\s+([A-Z_a-z]\\w*))?\\b"
        }
      ]
    },
    "declaration-storage": {
    ...
    "global-functions": {
      "patterns": [
        ...
        {
          "match": "\\b(s(?:elfdestruct|uicide))\\b",
