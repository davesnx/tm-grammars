...
let json = {json|{
  ...
  "repository": {
    ...
    "anonymous_pattern_18": {
      ...
      "match": "(\\s*)\\b(NS(Rect((?:To|From)CGRect)|MakeCollectable|S(tringFromProtocol|ize((?:To|From)CGSize))|Draw((?:Nin|Thre)ePartImage)|P(oint((?:To|From)CGPoint)|rotocolFromString)|EventMaskFromType|Value))\\b"
    },
          ...
          "patterns": [
            ...
            },
            {
              ...
              "patterns": [
                ...
                {
                  "match": "\\\\([\"'?\\\\abefnrtv]|[0-3]\\d{0,2}|[4-7]\\d?|x[0-9A-Za-z]+)",
    ...
    "c_functions": {
      "patterns": [
        ...
        },
        {
          ...
          "match": "(?:(?=\\s)(?:(?<=else|new|return)|(?<!\\w))(\\s+))?\\b((?!(while|for|do|if|else|switch|catch|enumerate|return|r?iterate)\\s*\\()(?:(?!NS)[A-Z_a-z][0-9A-Z_a-z]*+\\b|::)++)\\s*(\\()",
          "name": "meta.function-call.objcpp"
        }
      ]
    },
    "c_lang": {
      "patterns": [
        ...
        {
          "begin": "^\\s*((#)\\s*define)\\s+((?<id>[$A-Z_a-z][$\\w]*))(?:(\\()(\\s*\\g<id>\\s*((,)\\s*\\g<id>\\s*)*(?:\\.\\.\\.)?)(\\)))?",
          "beginCaptures": {
            "1": {
        ...
        {
          "match": "\\b(pthread_(?:attr_|cond_|condattr_|mutex_|mutexattr_|once_|rwlock_|rwlockattr_||key_)t)\\b",
          "name": "support.type.pthread.objcpp"
        },
        {
          "match": "\\b((?:int8|int16|int32|int64|uint8|uint16|uint32|uint64|int_least8|int_least16|int_least32|int_least64|uint_least8|uint_least16|uint_least32|uint_least64|int_fast8|int_fast16|int_fast32|int_fast64|uint_fast8|uint_fast16|uint_fast32|uint_fast64|intptr|uintptr|intmax|uintmax)_t)\\b",
      ...
      "repository": {
        "access-method": {
          "begin": "([A-Z_a-z][0-9A-Z_a-z]*|(?<=[])]))\\s*(?:(\\.)|(->))((?:[A-Z_a-z][0-9A-Z_a-z]*\\s*(?:\\.|->))*)\\s*([A-Z_a-z][0-9A-Z_a-z]*)(\\()",
          "beginCaptures": {
            "1": {
              "name": "variable.object.objcpp"
            },
        ...
        "block_innards": {
          "patterns": [
            ...
            {
              "begin": "(?=\\s)(?<!else|new|return)(?<=\\w)\\s+(and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas)((?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[]))\\s*(\\()",
              "beginCaptures": {
                "1": {
        ...
        "c_function_call": {
          "begin": "(?!(?:while|for|do|if|else|switch|catch|enumerate|return|typeid|alignof|alignas|sizeof|[cr]?iterate|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas)\\s*\\()(?=(?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++\\s*\\(|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[])\\s*\\()",
          "end": "(?<=\\))(?!\\w)",
          "name": "meta.function-call.objcpp",
          "patterns": [
            {
        ...
        "function-call-innards": {
          "patterns": [
            ...
            {
              "begin": "(?!(?:while|for|do|if|else|switch|catch|enumerate|return|typeid|alignof|alignas|sizeof|[cr]?iterate|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas)\\s*\\()((?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[]))\\s*(\\()",
              "beginCaptures": {
                "1": {
          ...
          "patterns": [
            {
              ...
              "match": "\\G(0[Xx])(\\h(?:\\h|((?<=\\h)'(?=\\h)))*)?((?<=\\h)\\.|\\.(?=\\h))(\\h(?:\\h|((?<=\\h)'(?=\\h)))*)?((?<!')([Pp])(\\+)?(-)?((?-im:[0-9](?:[0-9]|(?<=\\h)'(?=\\h))*)))?([FLfl](?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
              "captures": {
                "10": {
              ...
              "match": "\\G((?=[.0-9])(?!0[BXbx]))([0-9](?:[0-9]|((?<=\\h)'(?=\\h)))*)?((?<=[0-9])\\.|\\.(?=[0-9]))([0-9](?:[0-9]|((?<=\\h)'(?=\\h)))*)?((?<!')([Ee])(\\+)?(-)?((?-im:[0-9](?:[0-9]|(?<=\\h)'(?=\\h))*)))?([FLfl](?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
              "captures": {
                "1": {
              ...
              "match": "\\G(0[Bb])([01](?:[01]|((?<=\\h)'(?=\\h)))*)((?:(?:(?:(?:(?:[Uu]|[Uu]ll?)|[Uu]LL?)|ll?[Uu]?)|LL?[Uu]?)|[Ff])(?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
              "captures": {
                "1": {
              ...
              "match": "\\G(0)((?:[0-7]|((?<=\\h)'(?=\\h)))+)((?:(?:(?:(?:(?:[Uu]|[Uu]ll?)|[Uu]LL?)|ll?[Uu]?)|LL?[Uu]?)|[Ff])(?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
              "captures": {
                "1": {
              ...
              "match": "\\G(0[Xx])(\\h(?:\\h|((?<=\\h)'(?=\\h)))*)((?<!')([Pp])(\\+)?(-)?((?-im:[0-9](?:[0-9]|(?<=\\h)'(?=\\h))*)))?((?:(?:(?:(?:(?:[Uu]|[Uu]ll?)|[Uu]LL?)|ll?[Uu]?)|LL?[Uu]?)|[Ff])(?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
              "captures": {
                "2": {
              ...
              "match": "\\G((?=[.0-9])(?!0[BXbx]))([0-9](?:[0-9]|((?<=\\h)'(?=\\h)))*)((?<!')([Ee])(\\+)?(-)?((?-im:[0-9](?:[0-9]|(?<=\\h)'(?=\\h))*)))?((?:(?:(?:(?:(?:[Uu]|[Uu]ll?)|[Uu]LL?)|ll?[Uu]?)|LL?[Uu]?)|[Ff])(?!\\w))?(?!['.0-9A-Z_a-z]|(?<=[EPep])[-+])"
            },
            {
        ...
        "preprocessor-rule-conditional-line": {
          "patterns": [
            {
              "match": "\\bdefined\\b(?:\\s*$|(?=\\s*\\(*\\s*(?!defined\\b)[$A-Z_a-z][$\\w]*\\b\\s*\\)*\\s*(?:\\n|//|/\\*|[:?]|&&|\\|\\||\\\\\\s*\\n)))",
              "name": "keyword.control.directive.conditional.objcpp"
            },
            {
              "match": "\\bdefined\\b",
        ...
        "preprocessor-rule-define-line-contents": {
          "patterns": [
            ...
            {
              "begin": "(?!(?:while|for|do|if|else|switch|catch|enumerate|return|typeid|alignof|alignas|sizeof|[cr]?iterate|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas|asm|__asm__|auto|bool|_Bool|char|_Complex|double|enum|float|_Imaginary|int|long|short|signed|struct|typedef|union|unsigned|void)\\s*\\()(?=(?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++\\s*\\(|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[])\\s*\\()",
              "end": "(?<=\\))(?!\\w)|(?<!\\\\)(?=\\s*\\n)",
              "name": "meta.function.objcpp",
              "patterns": [
                {
        ...
        "probably_a_parameter": {
          ...
          "match": "(?<=[0-9A-Z_a-z] |[]\\&)*>])\\s*([A-Z_a-z]\\w*)\\s*(?=(?:\\[]\\s*)?[),])"
        },
        "static_assert": {
          "begin": "((?:s|_S)tatic_assert)\\s*(\\()",
          "beginCaptures": {
            "1": {
    ...
    "cpp_lang": {
      "patterns": [
        ...
        {
          "match": "\\b((?:const|dynamic|reinterpret|static)_cast)\\b\\s*",
        ...
        {
          "begin": "(?:^|(?<!else|new|=))((?:[A-Z_a-z][0-9A-Z_a-z]*::)*+~[A-Z_a-z][0-9A-Z_a-z]*)\\s*(\\()",
          "beginCaptures": {
            "1": {
              "name": "entity.name.function.objcpp"
            },
      ...
      "repository": {
          ...
          "patterns": [
            {
              ...
              "match": "((?!while|for|do|if|else|switch|catch|enumerate|return|r?iterate)(?:\\b[A-Z_a-z][0-9A-Z_a-z]*+\\b|::)*+)\\s*(\\()",
              "name": "meta.function-call.objcpp"
            },
            {
              "include": "$base"
        ...
        "constructor": {
          "patterns": [
            {
              "begin": "^\\s*((?!while|for|do|if|else|switch|catch|enumerate|r?iterate)[A-Z_a-z][0-:A-Z_a-z]*)\\s*(\\()",
              "beginCaptures": {
                "1": {
        ...
        "special_block": {
          "patterns": [
            {
              "begin": "\\b(using)\\b\\s*(namespace)\\b\\s*((?:[A-Z_a-z][0-9A-Z_a-z]*\\b(::)?)*)",
              "beginCaptures": {
                "1": {
                  "name": "keyword.control.objcpp"
                },
            ...
            {
              "begin": "\\b(namespace)\\b\\s*([A-Z_a-z][0-9A-Z_a-z]*\\b)?+",
              "beginCaptures": {
                "1": {
                  "name": "storage.type.namespace.objcpp"
                },
            ...
            {
              "begin": "\\b(?:(class)|(struct))\\b\\s*([A-Z_a-z][0-9A-Z_a-z]*\\b)?+(\\s*:\\s*(p(?:ublic|rotected|rivate))\\s*([A-Z_a-z][0-9A-Z_a-z]*)\\b((\\s*,\\s*(p(?:ublic|rotected|rivate))\\s*[A-Z_a-z][0-9A-Z_a-z]*\\b)*))?",
              "beginCaptures": {
                "1": {
        ...
        "template_definition_argument": {
          ...
          "match": "\\s*(?:([A-Z_a-z][0-9A-Z_a-z]*\\s*)|((?:[A-Z_a-z][0-9A-Z_a-z]*\\s+)*)([A-Z_a-z][0-9A-Z_a-z]*)|([A-Z_a-z][0-9A-Z_a-z]*)\\s*(\\.\\.\\.)\\s*([A-Z_a-z][0-9A-Z_a-z]*)|((?:[A-Z_a-z][0-9A-Z_a-z]*\\s+)*)([A-Z_a-z][0-9A-Z_a-z]*)\\s*(=)\\s*(\\w+))(,|(?=>))"
        }
      }
    },
    "cpp_lang_newish": {
      ...
      "repository": {
        "access-member": {
          ...
          "match": "(?:([A-Z_a-z]\\w*)|(?<=[])]))\\s*(?:(\\.\\*??)|(->\\*??))\\s*((?:[A-Z_a-z]\\w*\\s*(?:\\.|->)\\s*)*)\\b(?!auto|void|char|short|int|signed|unsigned|long|float|double|bool|wchar_t|u_char|u_short|u_int|u_long|ushort|uint|u_quad_t|quad_t|qaddr_t|caddr_t|daddr_t|div_t|dev_t|fixpt_t|blkcnt_t|blksize_t|gid_t|in_addr_t|in_port_t|ino_t|key_t|mode_t|nlink_t|id_t|pid_t|off_t|segsz_t|swblk_t|uid_t|id_t|clock_t|size_t|ssize_t|time_t|useconds_t|suseconds_t|pthread_attr_t|pthread_cond_t|pthread_condattr_t|pthread_mutex_t|pthread_mutexattr_t|pthread_once_t|pthread_rwlock_t|pthread_rwlockattr_t|pthread_t|pthread_key_t|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|int_least8_t|int_least16_t|int_least32_t|int_least64_t|uint_least8_t|uint_least16_t|uint_least32_t|uint_least64_t|int_fast8_t|int_fast16_t|int_fast32_t|int_fast64_t|uint_fast8_t|uint_fast16_t|uint_fast32_t|uint_fast64_t|intptr_t|uintptr_t|intmax_t|uintmax_t)([A-Z_a-z]\\w*)\\b(?!\\()",
          "name": "variable.other.object.access.objcpp"
        },
        "access-method": {
          "begin": "([A-Z_a-z][0-9A-Z_a-z]*|(?<=[])]))\\s*(?:(\\.)|(->))((?:[A-Z_a-z][0-9A-Z_a-z]*\\s*(?:\\.|->))*)\\s*([A-Z_a-z][0-9A-Z_a-z]*)(\\()",
          ...
          "patterns": [
            {
              ...
              "match": "((?!while|for|do|if|else|switch|catch|return)(?:\\b[A-Z_a-z][0-9A-Z_a-z]*+\\b|::)*+)\\s*(\\()",
              "name": "meta.function-call.objcpp"
            },
            {
              "include": "$base"
        ...
        "c_function_call": {
          "begin": "(?!(?:while|for|do|if|else|switch|catch|return|typeid|alignof|alignas|sizeof|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas)\\s*\\()(?=(?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++\\s*(?:<[,<>\\s\\w]*>\\s*)?\\(|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[])\\s*\\()",
          "end": "(?<=\\))(?!\\w)",
          "name": "meta.function-call.objcpp",
          "patterns": [
            {
        ...
        "constructor": {
          "patterns": [
            {
              "begin": "^\\s*((?!while|for|do|if|else|switch|catch)[A-Z_a-z][0-:A-Z_a-z]*)\\s*(\\()",
              "beginCaptures": {
                "1": {
                  "name": "entity.name.function.constructor.objcpp"
                },
        ...
        "function-call-innards-c": {
          "patterns": [
            ...
            {
              "begin": "(?<!\\w)(?!\\s*(?:not|compl|sizeof|new|delete|not_eq|bitand|xor|bitor|and|or|throw|and_eq|xor_eq|or_eq|alignof|alignas|typeid|noexcept|static_cast|dynamic_cast|const_cast|reinterpret_cast|while|for|do|if|else|goto|switch|try|catch|return|break|case|continue|default|auto|void|char|short|int|signed|unsigned|long|float|double|bool|wchar_t|u_char|u_short|u_int|u_long|ushort|uint|u_quad_t|quad_t|qaddr_t|caddr_t|daddr_t|div_t|dev_t|fixpt_t|blkcnt_t|blksize_t|gid_t|in_addr_t|in_port_t|ino_t|key_t|mode_t|nlink_t|id_t|pid_t|off_t|segsz_t|swblk_t|uid_t|id_t|clock_t|size_t|ssize_t|time_t|useconds_t|suseconds_t|pthread_attr_t|pthread_cond_t|pthread_condattr_t|pthread_mutex_t|pthread_mutexattr_t|pthread_once_t|pthread_rwlock_t|pthread_rwlockattr_t|pthread_t|pthread_key_t|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|int_least8_t|int_least16_t|int_least32_t|int_least64_t|uint_least8_t|uint_least16_t|uint_least32_t|uint_least64_t|int_fast8_t|int_fast16_t|int_fast32_t|int_fast64_t|uint_fast8_t|uint_fast16_t|uint_fast32_t|uint_fast64_t|intptr_t|uintptr_t|intmax_t|uintmax_t|NULL|true|false|nullptr|class|struct|union|enum|const|static|volatile|register|restrict|extern|inline|constexpr|mutable|friend|explicit|virtual|volatile|const|noexcept|constexpr|mutable|constexpr|consteval|private|protected|public|this|template|namespace|using|operator|typedef|decltype|typename|asm|__asm__|concept|requires|export|thread_local|atomic_cancel|atomic_commit|atomic_noexcept|co_await|co_return|co_yield|import|module|reflexpr|synchronized)\\s*\\()((?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*)\\s*([A-Z_a-z]\\w*)\\s*(<[,<>\\s\\w]*>\\s*)?(\\()",
              "beginCaptures": {
                "1": {
                  "patterns": [
                    {
        ...
        "function-innards-c": {
          "patterns": [
            ...
            {
              "begin": "(?!(?:while|for|do|if|else|switch|catch|return|typeid|alignof|alignas|sizeof|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas)\\s*\\()((?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[]))\\s*(\\()",
              "beginCaptures": {
                "1": {
                  "name": "entity.name.function.objcpp"
                },
        ...
        "number_literal": {
          ...
          "match": "((?<!\\w)(?:(?:(0[Xx])(\\h(?:\\h|((?<!')'(?!')))*)?((?<=\\h)\\.|\\.(?=\\h))(\\h(?:\\h|((?<!')'(?!')))*)?(?:([Pp])(\\+)?(-)?([0-9](?:[0-9]|(?<!')'(?!'))*))?|([0-9](?:[0-9]|((?<!')'(?!')))*)?((?<=[0-9])\\.|\\.(?=[0-9]))([0-9](?:[0-9]|((?<!')'(?!')))*)?(?:([Ee])(\\+)?(-)?([0-9](?:[0-9]|(?<!')'(?!'))*))?)([FLfl](?!\\w))?|(?:(?:(?:(0[Bb])((?:[01]|((?<!')'(?!')))+)|(0)((?:[0-7]|((?<!')'(?!')))+))|(0[Xx])(\\h(?:\\h|((?<!')'(?!')))*)(?:([Pp])(\\+)?(-)?([0-9](?:[0-9]|(?<!')'(?!'))*))?)|([0-9](?:[0-9]|((?<!')'(?!')))*)(?:([Ee])(\\+)?(-)?([0-9](?:[0-9]|(?<!')'(?!'))*))?)((?:(?:(?:(?:(?:(?:LL[Uu]|ll[Uu])|[Uu]LL)|[Uu]ll)|ll)|LL)|[LUlu])(?!\\w))?)(\\w*))"
        },
        "operator_overload": {
          "begin": "((?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*)\\s*(operator)(\\s*(?:\\+\\+|--|\\(\\)|\\[]|->|\\+\\+|--|[-!\\&*+~]|->\\*|[-%*+/]|<<|>>|<=>|<=??|>=??|==|!=|[\\&^|]|&&|\\|\\||=|\\+=|-=|\\*=|/=|%=|<<=|>>=|&=|\\^=|\\|=|,)|\\s+(?:(?:new|new\\[]|delete|delete\\[])|(?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*[A-Z_a-z]\\w*\\s*&?))\\s*(\\()",
          "beginCaptures": {
            "1": {
              "name": "entity.scope.objcpp"
            },
        ...
        "preprocessor-rule-define-line-contents": {
          "patterns": [
            ...
            {
              "begin": "(?!(?:while|for|do|if|else|switch|catch|return|typeid|alignof|alignas|sizeof|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eq|alignof|alignas|asm|__asm__|auto|bool|_Bool|char|_Complex|double|enum|float|_Imaginary|int|long|short|signed|struct|typedef|union|unsigned|void)\\s*\\()(?=(?:[A-Z_a-z][0-9A-Z_a-z]*+|::)++\\s*\\(|(?<=operator)(?:[-!\\&*+<=>]+|\\(\\)|\\[])\\s*\\()",
              "end": "(?<=\\))(?!\\w)|(?<!\\\\)(?=\\s*\\n)",
              "name": "meta.function.objcpp",
              "patterns": [
                {
        ...
        "probably_a_parameter": {
          ...
          "match": "([A-Z_a-z]\\w*)\\s*(?==)|(?<=\\w\\s|\\*/|[]\\&)*>])\\s*([A-Z_a-z]\\w*)\\s*(?=(?:\\[]\\s*)?[),])"
        },
        "scope_resolution": {
          "captures": {
            "1": {
          ...
          "match": "((?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*\\s*)([A-Z_a-z]\\w*)\\s*(<[,<>\\s\\w]*>\\s*)?(::)",
          "name": "meta.scope-resolution.objcpp"
        },
        "special_block": {
          "patterns": [
            {
              "begin": "\\b(using)\\s+(namespace)\\s+(?:((?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*)\\s*)?((?<!\\w)[A-Z_a-z]\\w*(?!\\w))(?=[\\n;])",
              "beginCaptures": {
                "1": {
            ...
            {
              "begin": "(?<!\\w)(namespace)\\s+(?:((?:[A-Z_a-z]\\w*\\s*(?:<[,<>\\s\\w]*>\\s*)?::)*[A-Z_a-z]\\w*)|(?=\\{))",
              "beginCaptures": {
                "1": {
        ...
        "template_definition_argument": {
          ...
          "match": "((?:(?:(?:\\s*([A-Z_a-z]\\w*)|((?:[A-Z_a-z]\\w*\\s+)+)([A-Z_a-z]\\w*))|([A-Z_a-z]\\w*)\\s*(\\.\\.\\.)\\s*([A-Z_a-z]\\w*))|((?:[A-Z_a-z]\\w*\\s+)*)([A-Z_a-z]\\w*)\\s*(=)\\s*(\\w+))\\s*(?:(,)|(?=>)))"
        },
        "vararg_ellipses-c": {
          "match": "(?<!\\.)\\.\\.\\.(?!\\.)",
          "name": "punctuation.vararg-ellipses.objcpp"
